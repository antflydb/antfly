      ...
      <div className="space-y-6">
        ...
        {currentSection === "artifacts" && (
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                Artifact inspection will show files and derived outputs attached to documents in
                this table.
              </p>
              <Button variant="outline" onClick={() => navigate(tableSectionPath("bulk"))}>
                Upload data
              </Button>
            </CardContent>
          </Card>
        ...
        {currentSection === "reprocess" && (
          <Card>
            <CardHeader>
              <CardTitle>Reprocess</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                Reprocessing will rerun document parsing, enrichment, chunking, and indexing for
                selected data once the backend exposes that workflow.
              </p>
              <Button variant="outline" onClick={() => navigate(tableSectionPath("indexes"))}>
                Review indexes
              </Button>
