...
- Distributed public query fan-in now preserves direct `graph_metric_results`
  ...
  `fresh` rejection, incompatible remote HITS pair rejection, and missing-status
  rejection.
...
- Promotion-scale use of the harness still needs deployment-sized graph indexes
  ...
  merges with active/stale prior-pair preservation, incompatible remote HITS
  pair rejection, and missing remote HITS status rejection through the real
...
- Promotion-scale fan-in should use shard layouts beyond the focused hosted
  ...
  active/stale prior-pair preservation, incompatible remote HITS pair rejection,
  and missing remote HITS status rejection, while
