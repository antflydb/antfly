...
func TestE2E_ClusterBackupRestore(t *testing.T) {
	...
	insertTestDocuments(t, ctx, standalone.Client, table1Name, table1Docs, antfly.SyncLevelQuery)
	insertTestDocuments(t, ctx, standalone.Client, table2Name, table2Docs, antfly.SyncLevelQuery)
