module github.com/antflydb/antfly/go/pkg/generating

go 1.26.0

replace (
	github.com/antflydb/antfly/go/pkg/genkit/openrouter => ../genkit/openrouter
...
require (
	...
	github.com/antflydb/antfly/go/pkg/genkit/openrouter v0.0.0
