...
func (r *InferencePool) ValidateCreate() error {
	return r.ValidateInferencePool()
}
...
func (r *InferencePool) ValidateUpdate(old runtime.Object) error {
	oldPool, ok := old.(*InferencePool)
	if !ok {
		return fmt.Errorf("expected *InferencePool, got %T", old)
	}
...
// ValidateInferencePool performs all validation checks
func (r *InferencePool) ValidateInferencePool() error {
...
func (r *InferencePool) validateGKEConfig() error {
	if r.Spec.GKE == nil {
		return nil
	}
...
func (r *InferencePool) validateNoConflictingSettings() error {
...
func (r *InferencePool) validateEKSConfig() error {
...
Example:
  spec:
    eks:
      enabled: true
      irsaRoleARN: "arn:aws:iam::123456789012:role/inference-model-registry-role"`, eks.IRSARoleARN)
		}
	}
...
func (r *InferencePool) validateNoConflictingCloudProviders() error {
...
func (r *InferencePool) validateReplicaCounts() error {
...
func (r *InferencePool) validateAutoscalingConfig() error {
...
func (r *InferencePool) ValidateImmutability(old *InferencePool) error {
	var errors []string
