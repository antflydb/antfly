...
func TestValidateInferencePool_InvalidAutoscalingTarget(t *testing.T) {
	pool := validPool()
	pool.Spec.Autoscaling = &AutoscalingConfig{
		Enabled: true,
		Metrics: []ScalingMetric{
...
func TestValidateInferencePool_InvalidAutoscalingPolicy(t *testing.T) {
	pool := validPool()
	pool.Spec.Autoscaling = &AutoscalingConfig{
		Enabled: true,
		Metrics: []ScalingMetric{
...
func TestValidateInferencePool_DisabledAutoscalingIgnoresMetricConfig(t *testing.T) {
	pool := validPool()
	pool.Spec.Autoscaling = &AutoscalingConfig{
		Enabled: false,
		Metrics: []ScalingMetric{
...
func TestValidateInferencePool_DisabledAutoscalingStillRejectsImpossibleValues(t *testing.T) {
	pool := validPool()
	warmup := int32(-1)
	pool.Spec.Autoscaling = &AutoscalingConfig{
		Enabled:        false,
...
func TestValidateInferencePool_RejectsHPAStabilizationAboveLimit(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_RejectsHPAPeriodAboveLimit(t *testing.T) {
	pool := validPool()
	pool.Spec.Autoscaling = &AutoscalingConfig{
		Enabled: true,
		Metrics: []ScalingMetric{
...
func TestValidateInferencePool_MinGreaterThanMax(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_NegativeMin(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_ZeroMax(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_ComputeClassWithoutAutopilot(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_AcceleratorWithoutGPU(t *testing.T) {
	pool := validPool()
	pool.Spec.GKE = &GKEConfig{
		Autopilot:             true,
...
func TestValidateInferencePool_AcceleratorWithGPU(t *testing.T) {
	pool := validPool()
	pool.Spec.GKE = &GKEConfig{
		Autopilot:             true,
		AutopilotComputeClass: "Accelerator",
...
func TestValidateInferencePool_SpotConflictsWithAutopilot(t *testing.T) {
	pool := validPool()
...
func TestValidateInferencePool_NodeSelectorConflictsWithAutopilot(t *testing.T) {
	pool := validPool()
	pool.Spec.GKE = &GKEConfig{Autopilot: true}
...
func TestValidateInferencePool_GKEAndEKSConflict(t *testing.T) {
	pool := validPool()
	pool.Spec.GKE = &GKEConfig{Autopilot: true}
...
func TestValidateInferencePool_GKENonAutopilotAndEKSConflict(t *testing.T) {
	pool := validPool()
...
func TestValidateEKS_ValidIRSARoleARN(t *testing.T) {
	...
	pool.Spec.EKS = &EKSConfig{
		Enabled:     true,
		IRSARoleARN: "arn:aws:iam::123456789012:role/inference-role",
	}
...
func TestValidateInferencePool_AllowsCustomAntflyCompatibleImage(t *testing.T) {
	pool := validPool()
