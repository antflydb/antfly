...
diagnostics for the complete configured source set. Inspect the canonical
`config.sources` list to identify that set; current readiness does not attribute
lag to an individual source. Do not infer readiness from replay counters alone.
