...
projection contains at most 64 unique aliases; omit the projection only when all
declared aliases are required. These bounds keep admission predictable and let
the matcher compile projection membership once per operation.
