...
```bash
antfly termite pull BAAI/bge-small-en-v1.5 openai/clip-vit-base-patch32 mixedbread-ai/mxbai-rerank-base-v1
antfly termite pull hf:onnx-community/gemma-3-270m-it-ONNX
```

- `BAAI/bge-small-en-v1.5` is a small, fast text embedding model (384 dimensions) for semantic search
