...
Concrete visual descriptions ("red sports car", "mountain landscape") work better than abstract ones. To search with an image instead of words, see [Build Image Search](/docs/guides/multimodal).
</Steps>
...
- [Build Image Search](/docs/guides/multimodal): the image index from this page, plus searching with an image instead of words
