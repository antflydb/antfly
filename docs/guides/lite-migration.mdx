...
- `.afb` is an Antfly Backup Bundle. Its manifest explicitly identifies a
  `portable` logical or `native` physical representation; Lite produces and
  consumes the portable representation.
