...
Then prompt it with the outcome — e.g. "Set up local embeddings and reranking with Antfly Inference and wire them into my table's index" — and use this page to judge the result.
