...
cancellation timings, topology/stale-owner, additional target-crash timings,
and overlapping-fault variants, plus cache deadline/topology/fault overlap,
remain future breadth.
...
topology/stale-owner, and cross-domain overlap remain separate future modes;
v44 promotes one exact target-owner restart, v45 one exact source-session
crash, and v46 one durable-checkpoint cancellation below.
...
additional cancellation timings, topology/stale-owner, other target-crash
timings, and cross-domain overlap remain separate future modes.
...
topology/stale-owner, other target-crash timings, and cross-domain overlap
...
topology/stale-owner, source/target process overlap, and other cross-domain
fault shapes remain separate modes.
V41-v46 directly add their modes, properties, trace revisions,
...
are green, and the cited v13-v40 production-owner gates plus the v41-v46
...
through v46; each large subprocess uses ordinary
...
- extend the v41-v46 cluster compositions with search policies that overlap
  node-wide and operation-class slowdowns
  with public deadlines, topology/ownership changes, the existing
  link/storage/resource/restart algebra, replication topology/stale-owner,
  additional cancellation and source/target-crash cases, and quiet recovery.
  The reusable effect, clean backfill, schema-resume, exact target-owner-
  restart, prepared-source-session-crash, and durable-checkpoint-cancellation
...
3. Co-locate production HA and data-plane owners, extend the integrated
   ...
   no duplicate target work. Next overlap
