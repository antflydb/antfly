...
Backfill source crash, cancellation, topology/stale-owner, additional target-
...
and ReleaseSafe gates pass 15/15. Source crash, cancellation, topology/stale-
owner, and cross-domain overlap remain separate future modes; v44 promotes one
exact target-owner restart below.
...
post-first-batch target-leader restart; source crash, cancellation, topology/
stale-owner, other target-crash timings, and cross-domain overlap remain
separate future modes.
V41-v44 directly add their modes, properties, trace revisions,
...
are green, and the cited v13-v40 production-owner gates plus the v41-v44
...
through v44; each large subprocess uses ordinary
...
- extend the v41-v44 cluster compositions with search policies that overlap
  node-wide and operation-class slowdowns
  with public deadlines, topology/ownership changes, the existing
  link/storage/resource/restart algebra, remaining replication source-crash,
  cancellation, topology/stale-owner and additional target-crash cases, and
  quiet recovery. The reusable effect, clean backfill, schema-resume, and exact
  target-owner-restart compositions are complete;
