...
source-crash timings, cancellation, topology/stale-owner, additional target-
crash timings, and overlapping-fault variants, plus cache deadline/topology/
fault overlap, remain future breadth.
...
and ReleaseSafe gates pass 15/15. Cancellation, topology/stale-owner, and cross-
domain overlap remain separate future modes; v44 promotes one exact target-
owner restart and v45 one exact source-session crash below.
...
cancellation, topology/stale-owner, other target-crash timings, and cross-
domain overlap remain separate future modes.
...
source-crash timings or source-process loss, cancellation, topology/stale-owner,
other target-crash timings, and cross-domain overlap remain separate modes.
V41-v45 directly add their modes, properties, trace revisions,
...
are green, and the cited v13-v40 production-owner gates plus the v41-v45
...
through v45; each large subprocess uses ordinary
...
- extend the v41-v45 cluster compositions with search policies that overlap
  node-wide and operation-class slowdowns
  with public deadlines, topology/ownership changes, the existing
  link/storage/resource/restart algebra, remaining replication cancellation,
  topology/stale-owner and additional source/target-crash cases, and quiet
  recovery. The reusable effect, clean backfill, schema-resume, exact target-
  owner-restart, and exact prepared-source-session-crash compositions are
  complete;
...
3. Co-locate production HA and data-plane owners, extend the integrated
   ...
   replacement, and durable resume without extra target work. Next overlap
