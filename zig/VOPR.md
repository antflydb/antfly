...
cover metadata, transaction, Raft, storage, HA, data-plane, derived-workflow,
...
3. **Compose independently proven fault domains, including HA and the data plane.** Already composed:
   ...
   - Co-locate HA and the data plane; add managed-index and graph/query disk-pressure combinations;
...
5. **Operationalize and maintain the self-contained platform tooling.** The command composer,
   ...
   - Adopt the registered-deployment composer beyond full-cluster in the HA, data-plane,
