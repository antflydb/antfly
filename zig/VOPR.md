...
session, and resumes without adding or duplicating target batches. Additional
...
replay. Metadata topology/cutover-authority changes, additional target-crash
timings, and overlapping-fault variants, plus cache deadline/topology/fault
overlap, remain future breadth.
...
and ReleaseSafe gates pass 15/15. Additional cancellation timings,
metadata topology/cutover-authority changes, and cross-domain overlap remain
separate future modes; v44 promotes one exact target-owner restart, v45 one
exact source-session crash, v46 one durable-checkpoint cancellation, and v47
one pre-checkpoint stale-owner rejection below.
...
post-first-batch target-leader restart; additional source-crash timings,
additional cancellation timings, metadata topology/cutover-authority changes,
other target-crash timings, and cross-domain overlap remain separate future
modes.
...
metadata topology/cutover-authority changes, other target-crash timings, and
cross-domain overlap remain separate modes.
...
metadata topology/cutover-authority changes, source/target process overlap, and
other cross-domain fault shapes remain separate modes.
...
transition Debug and ReleaseSafe gates pass 15/15. Metadata topology and
cutover-authority rotation, other ownership-loss timings, and cross-domain
overlap remain separate modes.
V41-v47 directly add their modes, properties, trace revisions,
...
are green, and the cited v13-v40 production-owner gates plus the v41-v47
...
through v47; each large subprocess uses ordinary
...
- extend the v41-v47 cluster compositions with search policies that overlap
  node-wide and operation-class slowdowns
  with public deadlines, topology/ownership changes, the existing
  link/storage/resource/restart algebra, replication metadata topology/cutover-
  authority changes, additional cancellation and source/target-crash cases,
  and quiet recovery.
  ...
  pre-checkpoint stale-owner compositions are complete;
