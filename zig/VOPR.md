...
cross-domain overlap, plus other target-crash timings and cache
deadline/topology/fault overlap, remain future breadth.
...
V41-v48 directly add their modes, properties, trace revisions,
...
are green, and the cited v13-v40 production-owner gates plus the v41-v48
...
- extend the v41-v48 cluster compositions with search policies that overlap
  ...
  pre-checkpoint stale-owner and metadata-backed exact-authority-rotation
