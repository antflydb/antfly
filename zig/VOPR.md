...
6. Maintain full Iceberg/Parquet discovery-to-row materialization,
...
The identified P0, P1, and non-conditional P2 orchestration, media, and
upgrade/compatibility suites are integrated. The hard
