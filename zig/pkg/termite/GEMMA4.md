...
```text
bundle: pkg/termite/.debug/metal-command-20260505-162324
...
```text
bundle: pkg/termite/.debug/metal-command-20260505-170606
validation: MTL_DEBUG_LAYER=1, MTL_SHADER_VALIDATION=0
...
```text
bundle: pkg/termite/.debug/metal-command-20260506-161752
validation: MTL_DEBUG_LAYER=1, MTL_SHADER_VALIDATION=0
...
```text
bundle: pkg/termite/.debug/metal-command-20260507-142101
validation: MTL_DEBUG_LAYER=1, MTL_SHADER_VALIDATION=0
...
(`pkg/termite/.debug/metal-command-20260507-214829`, panic
