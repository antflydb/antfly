...
- `pkg/termite/lib/reading/reader.go`
- `pkg/termite/lib/reading/multistage_reader.go`
- `pkg/termite/lib/pipelines/multistage_ocr.go`
- `pkg/termite/lib/pipelines/multistage_ocr_loader.go`
- `pkg/termite/reader_registry.go`
...
- the default build now passes `zig build test`, `e2e/termite/test_version.py`, and the `monkt/paddleocr-onnx` multistage `/api/read` e2e without extra `-Donnx=true` flags
...
- extend `e2e/termite/test_read.py` for:
  - optional `fields`
  - optional `regions`
