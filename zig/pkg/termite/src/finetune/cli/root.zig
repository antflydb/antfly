...
fn usage() void {
    std.debug.print(
        ...
        \\  termite finetune dataset inspect <gliner2|reranker> ...
        \\  termite finetune dataset generate <gemma4-pilot|gemma4-multimodal-pilot> ...
        \\  termite finetune dataset prepare <family-or-cache> ...
        \\  termite finetune dataset materialize gemma4-teacher-targets ...
        ...
        \\  termite finetune adapter compose lora ...
        \\  termite finetune train <task> ...
        \\  termite finetune eval <task> ...
        \\  termite finetune workflow <workflow> ...
        \\
        \\examples:
