...
def harness_provenance(script_path: pathlib.Path) -> dict[str, Any]:
    ...
    files = {
        ...
        "pairing_support": path_provenance(script_path.with_name("paired_benchmark.py")),
    }
    identity = {
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    scripts = repo / "zig/pkg/inference/scripts"
    ...
    parser.add_argument("--fixture", type=pathlib.Path, default=scripts / "fixtures/gemma4_long_context_v1.json")
