...
- `lib/pjrt/proto/hlo.desc` now drives generated XLA protobuf bindings for the HLO proto subset used by the current builder; PJRT CPU-plugin tests compile and execute those partition HLOs when the plugin is present.
