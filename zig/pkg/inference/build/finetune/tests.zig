...
const tests = [_]common.TestSpec{
    .{
        .step_name = "layoutlmv3-finetune-test",
    ...
    .{
        .step_name = "colqwen2-finetune-test",
    ...
    .{
        .step_name = "gliner2-backend-grad-parity-test",
    ...
    .{
        .step_name = "gliner2-real-training-test",
    ...
    .{
        .step_name = "gliner2-run-validation-test",
    ...
    .{
        .step_name = "gliner2-autodiff-trainer-test",
    ...
    .{
        .step_name = "gliner2-graph-cache-test",
    ...
    .{
        .step_name = "gliner2-native-eval-test",
    ...
    .{
        .step_name = "entity-cleanup-gliner-cache-test",
    ...
    .{
        .step_name = "gliner2-cleanup-bundle-test",
