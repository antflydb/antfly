...
fn printRuntimeDebugTimingStats(metal_stats: model_runtime.RuntimeDebugTimingStats, has_runtime: bool) void {
    ...
    std.debug.print(
        " sample_calls={d} sample_direct={d} sample_fallback={d} greedy_calls={d} greedy_direct={d} greedy_fallback={d} greedy_token_handoff_attempts={d} greedy_token_handoff_hits={d} greedy_token_handoff_fallbacks={d} greedy_token_seeds={d} ensure_prepared_calls={d} ensure_prepared={d} ensure_sync={d} ensure_family={d} ensure_greedy={d} ensure_fast_hits={d}\n",
        .{
