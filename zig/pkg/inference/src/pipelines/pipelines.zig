...
pub const extraction_constraints = @import("extraction_constraints.zig");
pub const extraction_schema = @import("extraction_schema.zig");
pub const extraction_assignment = @import("extraction_assignment.zig");
pub const extraction_joint_ie = @import("extraction_joint_ie.zig");
pub const gliner_boundary_decode = @import("gliner_boundary_decode.zig");
pub const gliner_boundary_records = @import("gliner_boundary_records.zig");
pub const gliner_boundary_relations = @import("gliner_boundary_relations.zig");
pub const gliner_boundary_processor = @import("gliner_boundary_processor.zig");
pub const gliner_boundary_pipeline = @import("gliner_boundary_pipeline.zig");
pub const gliner_boundary_joint = @import("gliner_boundary_joint.zig");
pub const gliner_boundary_long_document = @import("gliner_boundary_long_document.zig");
pub const gliner_boundary_record_selection = @import("gliner_boundary_record_selection.zig");
pub const gliner_boundary_long_relations = @import("gliner_boundary_long_relations.zig");
pub const extraction_regex = @import("extraction_regex.zig");
...
test {
    _ = extraction_constraints;
    _ = extraction_schema;
    _ = extraction_assignment;
    _ = extraction_joint_ie;
    _ = gliner_boundary_decode;
    _ = gliner_boundary_records;
    _ = gliner_boundary_relations;
    _ = gliner_boundary_processor;
    _ = gliner_boundary_pipeline;
    _ = gliner_boundary_joint;
    _ = gliner_boundary_long_document;
    _ = gliner_boundary_record_selection;
    _ = gliner_boundary_long_relations;
    _ = extraction_regex;
    _ = @import("gliner_boundary_unicode.zig");
