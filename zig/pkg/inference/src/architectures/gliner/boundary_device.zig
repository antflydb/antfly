...
const primitives = @import("boundary_ops.zig");
...
pub const Result = struct {
    ...
    pub fn scoreExplicit(self: *Result, input: @import("boundary_head.zig").ExplicitInput) !ExplicitResult {
    ...
    pub fn scoreExplicitSubset(self: *Result, sample: usize, queries: []const usize, input: @import("boundary_head.zig").ExplicitInput) !ExplicitResult {
...
fn scoreExplicitSpans(result: *Result, explicit: @import("boundary_head.zig").ExplicitInput) !ExplicitResult {
...
fn scoreExplicitView(view: ExplicitView, explicit: @import("boundary_head.zig").ExplicitInput) !ExplicitResult {
    const o = view.owner;
    try o.math.check();
...
fn explicitSubset(result: *Result, sample: usize, queries: []const usize, explicit: @import("boundary_head.zig").ExplicitInput) !ExplicitResult {
