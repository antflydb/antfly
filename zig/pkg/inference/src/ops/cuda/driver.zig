...
pub const CudaDriver = struct {
    ...
    pub const Table = struct {
        ...
        cuDeviceGetAttribute: ?*const fn (value: *c_int, attrib: c_int, device: CUdevice) callconv(.c) CUresult = null,
        ...
        cuMemGetInfo: *const fn (free_bytes: *usize, total_bytes: *usize) callconv(.c) CUresult,
    ...
    pub fn open() Error!CudaDriver {
        ...
        return .{
            ...
            .fns = .{
                ...
                .cuDeviceGetAttribute = lookupOptional(&lib, *const fn (value: *c_int, attrib: c_int, device: CUdevice) callconv(.c) CUresult, "cuDeviceGetAttribute"),
                ...
                .cuMemGetInfo = lookup(&lib, @TypeOf(@as(Table, undefined).cuMemGetInfo), "cuMemGetInfo_v2") catch return error.CudaSymbolMissing,
