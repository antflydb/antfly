...
pub const TensorType = union(enum) {
    ...
    pub fn fromRawForDialect(raw_value: u32, dialect: Dialect) TensorType {
        ...
        return switch (raw_value) {
            @backingInt(KnownTensorType.F32) => .{ .known = .F32 },
            @backingInt(KnownTensorType.F16) => .{ .known = .F16 },
            @backingInt(KnownTensorType.Q4_0) => .{ .known = .Q4_0 },
            @backingInt(KnownTensorType.Q4_1) => .{ .known = .Q4_1 },
            @backingInt(KnownTensorType.Q5_0) => .{ .known = .Q5_0 },
            @backingInt(KnownTensorType.Q5_1) => .{ .known = .Q5_1 },
            @backingInt(KnownTensorType.Q8_0) => .{ .known = .Q8_0 },
            @backingInt(KnownTensorType.Q8_1) => .{ .known = .Q8_1 },
            @backingInt(KnownTensorType.Q2_K) => .{ .known = .Q2_K },
            @backingInt(KnownTensorType.Q3_K) => .{ .known = .Q3_K },
            @backingInt(KnownTensorType.Q4_K) => .{ .known = .Q4_K },
            @backingInt(KnownTensorType.Q5_K) => .{ .known = .Q5_K },
            @backingInt(KnownTensorType.Q6_K) => .{ .known = .Q6_K },
            @backingInt(KnownTensorType.Q8_K) => .{ .known = .Q8_K },
            @backingInt(KnownTensorType.IQ2_XXS) => .{ .known = .IQ2_XXS },
            @backingInt(KnownTensorType.IQ2_XS) => .{ .known = .IQ2_XS },
            @backingInt(KnownTensorType.IQ3_XXS) => .{ .known = .IQ3_XXS },
            @backingInt(KnownTensorType.IQ1_S) => .{ .known = .IQ1_S },
            @backingInt(KnownTensorType.IQ4_NL) => .{ .known = .IQ4_NL },
            @backingInt(KnownTensorType.IQ3_S) => .{ .known = .IQ3_S },
            @backingInt(KnownTensorType.IQ2_S) => .{ .known = .IQ2_S },
            @backingInt(KnownTensorType.IQ4_XS) => .{ .known = .IQ4_XS },
            @backingInt(KnownTensorType.I8) => .{ .known = .I8 },
            @backingInt(KnownTensorType.I16) => .{ .known = .I16 },
            @backingInt(KnownTensorType.I32) => .{ .known = .I32 },
            @backingInt(KnownTensorType.I64) => .{ .known = .I64 },
            @backingInt(KnownTensorType.F64) => .{ .known = .F64 },
            @backingInt(KnownTensorType.IQ1_M) => .{ .known = .IQ1_M },
            @backingInt(KnownTensorType.BF16) => .{ .known = .BF16 },
            @backingInt(KnownTensorType.TQ1_0) => .{ .known = .TQ1_0 },
            @backingInt(KnownTensorType.TQ2_0) => .{ .known = .TQ2_0 },
            @backingInt(KnownTensorType.I2_S) => .{ .known = .I2_S },
            @backingInt(KnownTensorType.I8_S) => .{ .known = .I8_S },
            @backingInt(KnownTensorType.TL1) => .{ .known = .TL1 },
            @backingInt(KnownTensorType.MXFP4) => .{ .known = .MXFP4 },
            @backingInt(KnownTensorType.NVFP4) => .{ .known = .NVFP4 },
            @backingInt(KnownTensorType.Q1_0) => .{ .known = .Q1_0 },
