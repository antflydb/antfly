...
fn publishedSmall(source_path: []const u8, execution: Execution, mode: @import("boundary_run.zig").Mode) !void {
...
test "boundary training job regional numeric limits preserve semantics and enclosing admission" {
    ...
    const native_defaults = @import("boundary_native_trainer.zig").Limits{};
    ...
    raised.training_limits = @import("boundary_training_limits.zig").hard;
