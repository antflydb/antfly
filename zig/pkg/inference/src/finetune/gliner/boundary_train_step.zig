...
const boundary_ops = @import("../../architectures/gliner/boundary_ops.zig");
const graph_mod = @import("../../architectures/gliner/boundary_graph.zig");
const candidate_graph = @import("../../architectures/gliner/boundary_graph_candidates.zig");
const task_graph = @import("../../architectures/gliner/boundary_graph_tasks.zig");
const encoder_graph = @import("boundary_encoder_graph.zig");
const peft_graph = @import("boundary_peft_graph.zig");
const recomputed_graph = @import("boundary_recomputed_graph.zig");
const recomputed = @import("../../graph/recomputed_training.zig");
const replay_bindings = @import("boundary_replay_bindings.zig");
const recomputed_admission = @import("boundary_recomputed_admission.zig");
const recomputed_execution = @import("boundary_recomputed_execution.zig");
const targets_mod = @import("boundary_targets.zig");
const selection = @import("boundary_selection.zig");
const decisions = @import("boundary_train_decisions.zig");
...
const record_loss = @import("boundary_record_loss.zig");
...
test "boundary training step cached plan runs compose host checks and reset terminal allocation history" {
    const fixture = @import("boundary_train_step_test.zig");
...
test {
    _ = @import("boundary_train_step_test.zig");
    _ = objectives;
    _ = decisions;
}
