...
fn printUsage() void {
    print(
        \\usage: antfly inference classify <model-dir> [<text>] [--text <text>]... --label <label>... [--backend auto|onnx|native|metal|pjrt] [--graph-runtime interpreter|partitioned|compiled|compiled-required] [--multi-label] [--hypothesis-template <template>] [--entailment-index <n>]
