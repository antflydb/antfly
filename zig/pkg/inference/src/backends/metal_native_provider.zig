...
pub const MetalNativeProvider = if (build_options.enable_metal) struct {
    ...
    raw_linear_slot_bias_is_zero: [decoder_runtime_linear_slot_capacity]bool = [_]bool{false} ** decoder_runtime_linear_slot_capacity,
    ...
    raw_linear_slot_model_buffer_bound: [decoder_runtime_linear_slot_capacity]bool = [_]bool{false} ** decoder_runtime_linear_slot_capacity,
