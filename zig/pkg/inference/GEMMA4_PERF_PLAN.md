...
separately in `docs/CUDA_TUNING.md` ("Gemma 4 E2B SM89 optimization status").
...
> [work-log/completed/inference/gemma4-perf-plan-ledgers.md](../../../work-log/completed/inference/gemma4-perf-plan-ledgers.md).
