...
pub const InferenceToolCall = types.InferenceToolCall;
pub const InferenceToolCallFunction = types.InferenceToolCallFunction;
...
pub const InferenceBackendCapabilities = types.InferenceBackendCapabilities;
