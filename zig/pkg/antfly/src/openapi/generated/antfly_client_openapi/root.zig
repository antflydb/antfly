...
pub const HypervectorEncodingConfig = types.HypervectorEncodingConfig;
pub const HypervectorIndexConfig = types.HypervectorIndexConfig;
pub const HypervectorSemanticConfig = types.HypervectorSemanticConfig;
pub const HypervectorStructuralConfig = types.HypervectorStructuralConfig;
