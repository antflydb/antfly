...
pub const ModelRef = struct {
    ...
    /// Per-model A4B memory envelope in MiB. Zero selects the conservative 2048 MiB streamed floor. Explicit values below 2048 fail model load; `resident` also fails unless all experts and reserves fit.
