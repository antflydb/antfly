...
pub const Config = struct {
    ...
    /// Generator model names to load and warm at startup. These models are loaded immediately when Antfly inference starts, avoiding first-request latency. Use warm_models for non-generator targets or backend-specific generator warmup.
