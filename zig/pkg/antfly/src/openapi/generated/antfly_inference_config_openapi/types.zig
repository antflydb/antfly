...
pub const Config = struct {
    ...
    /// Legacy list of generator model names to preload at startup. These models are loaded immediately when Antfly inference starts, avoiding first-request latency. Prefer warm_models for new config because it records the model kind and optional backend.
