...
pub const RestoreAcceptedResponse = types.RestoreAcceptedResponse;
pub const RestoreCommittedDurableResponse = types.RestoreCommittedDurableResponse;
pub const RestoreCommittedPendingResponse = types.RestoreCommittedPendingResponse;
pub const RestoreRequest = types.RestoreRequest;
pub const RestoreTriggeredResponse = types.RestoreTriggeredResponse;
