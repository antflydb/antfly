...
pub const HAAdminConfig = types.HAAdminConfig;
pub const HAConfig = types.HAConfig;
pub const HAIdentityConfig = types.HAIdentityConfig;
pub const HAPrimaryConfig = types.HAPrimaryConfig;
pub const HARetentionConfig = types.HARetentionConfig;
pub const HAStandbyConfig = types.HAStandbyConfig;
pub const HASyncConfig = types.HASyncConfig;
