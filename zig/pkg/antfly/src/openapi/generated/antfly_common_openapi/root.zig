...
pub const AwsCredentialConfigSource = types.AwsCredentialConfigSource;
pub const CdcConnectionVariantKind = types.CdcConnectionVariantKind;
pub const ConfigDeploymentMode = types.ConfigDeploymentMode;
pub const ExternalIoConnectionVariantKind = types.ExternalIoConnectionVariantKind;
pub const FilesystemExternalIoConfigProtocol = types.FilesystemExternalIoConfigProtocol;
pub const GcsCredentialConfigSource = types.GcsCredentialConfigSource;
pub const GcsExternalIoConfigProtocol = types.GcsExternalIoConfigProtocol;
pub const GcsExternalIoConfigBucketProvisioning = types.GcsExternalIoConfigBucketProvisioning;
pub const HttpExternalIoConfigProtocol = types.HttpExternalIoConfigProtocol;
pub const InferenceConnectionVariantKind = types.InferenceConnectionVariantKind;
pub const S3ExternalIoConfigProtocol = types.S3ExternalIoConfigProtocol;
pub const S3ExternalIoConfigAddressingStyle = types.S3ExternalIoConfigAddressingStyle;
pub const S3ExternalIoConfigBucketProvisioning = types.S3ExternalIoConfigBucketProvisioning;
pub const WebSearchConnectionVariantKind = types.WebSearchConnectionVariantKind;
