...
%token JOIN KEY LAST LATERAL LEFT LIKE LIMIT MATCHED MERGE METRIC NOT NULL NULLS ON OR ORDER OUTER OVER PARTITION PRECEDING PREPARE PRIMARY PUBLIC
...
primary_expression:
  ...
  | qualified_name LPAREN function_argument_list_opt RPAREN filter_clause_opt
  ;
