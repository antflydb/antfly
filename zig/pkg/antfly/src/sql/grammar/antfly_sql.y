...
%token ACCESS ADD AGGREGATE ALL ALTER ANALYZE AND ANY ARRAY AS ASC ASYMMETRIC AUTHORIZATION BACKUP BEGIN BETWEEN BY CASCADE CALL CASE CAST CHECK CHECKPOINT CLOSE CLUSTER COLLATION COMMIT COMMENT CONCURRENTLY CONFLICT CONSTRAINT CONTINUE CURRENT CURRENT_DATE CURRENT_TIMESTAMP
