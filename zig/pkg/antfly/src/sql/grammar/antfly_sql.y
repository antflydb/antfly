...
%token EXPLAIN EXISTS EXTENSION FALSE FETCH FIRST FOLLOWING FROM FULL GRAPH GROUP HAVING IDENTITY IF INDEX INSERT INTO
%token JOIN KEY LATERAL LIMIT MATCHED MERGE METRIC NOT NULL ON OR ORDER OVER PARTITION PRECEDING PREPARE PRIMARY PUBLIC
