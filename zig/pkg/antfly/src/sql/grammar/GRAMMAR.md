...
- Plan parity tests showing generated ASTs lower to the same typed plans as the
  ...
  `CREATE TABLE`, `DROP TABLE`, `DROP INDEX`, non-partial generated
  `CREATE INDEX`, and single-operation generated `ALTER TABLE ADD/DROP/RENAME
  COLUMN` plus `VALIDATE CONSTRAINT` through the generated AST-to-plan
  boundary; generated session lowering preserves catalog setting/search-path
  plans and adapter noops while failing closed when retained
  ...
  index predicates, serial pseudo-type table allocation, row-security ALTER
  routing, multi-operation ALTER statements, and broader ALTER/check
  expression payloads.
