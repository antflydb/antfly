...
- Plan parity tests showing generated ASTs lower to the same typed plans as the
  ...
  `DROP INDEX`, non-partial generated `CREATE INDEX`, and single-operation
  generated `ALTER TABLE ADD/DROP/RENAME COLUMN` plus `VALIDATE CONSTRAINT`
  ...
  index predicates, row-security ALTER routing, multi-operation ALTER
  statements, and broader ALTER/check expression payloads.
