...
- [ ] Function and expression semantic completion
  - [ ] Finish direct generated-payload lowering for expression families that still rely on token-layout fallback: type coercion, arrays, temporal literals, generic functions, and aggregate/window argument, `FILTER`, `WITHIN GROUP`, and `OVER` payloads.
