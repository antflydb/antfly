...
pub const lowerSelectAlloc = lower_select.lowerSelectAlloc;
pub const lowerSelectParsedSqlAlloc = lower_select.lowerSelectParsedSqlAlloc;
pub const lowerQueryPlanAlloc = lower_select.lowerQueryPlanAlloc;
pub const lowerQueryPlanWithExtensionFunctionsAlloc = lower_select.lowerQueryPlanWithExtensionFunctionsAlloc;
pub const lowerQueryPlanWithFunctionBindingsAlloc = lower_select.lowerQueryPlanWithFunctionBindingsAlloc;
...
pub const lowerReadPlanWithExtensionFunctionsAlloc = lower_select.lowerReadPlanWithExtensionFunctionsAlloc;
pub const lowerReadPlanWithFunctionBindingsAlloc = lower_select.lowerReadPlanWithFunctionBindingsAlloc;
pub const lowerReadPlanWithFunctionBindingsParsedSqlAlloc = lower_select.lowerReadPlanWithFunctionBindingsParsedSqlAlloc;
pub const lowerReadPlanWithSchemasAlloc = lower_select.lowerReadPlanWithSchemasAlloc;
pub const lowerReadPlanWithSchemasAndExtensionFunctionsAlloc = lower_select.lowerReadPlanWithSchemasAndExtensionFunctionsAlloc;
pub const lowerReadPlanWithSchemasAndFunctionBindingsAlloc = lower_select.lowerReadPlanWithSchemasAndFunctionBindingsAlloc;
pub const lowerReadPlanWithSchemasAndFunctionBindingsParsedSqlAlloc = lower_select.lowerReadPlanWithSchemasAndFunctionBindingsParsedSqlAlloc;
const lowerReadPlanWithOptionalSourceSchemaAlloc = lower_select.lowerReadPlanWithOptionalSourceSchemaAlloc;
const lowerReadPlanWithOptionalSourceSchemaParsedSqlAlloc = lower_select.lowerReadPlanWithOptionalSourceSchemaParsedSqlAlloc;
pub const lowerRecursiveCtePlanAlloc = lower_select.lowerRecursiveCtePlanAlloc;
pub const lowerRecursiveCtePlanParsedSqlAlloc = lower_select.lowerRecursiveCtePlanParsedSqlAlloc;
pub const lowerSetOperationPlanAlloc = lower_select.lowerSetOperationPlanAlloc;
pub const lowerSetOperationPlanParsedSqlAlloc = lower_select.lowerSetOperationPlanParsedSqlAlloc;
pub const lowerSetOperationPlanWithFunctionBindingsAlloc = lower_select.lowerSetOperationPlanWithFunctionBindingsAlloc;
pub const lowerSetOperationPlanWithFunctionBindingsParsedSqlAlloc = lower_select.lowerSetOperationPlanWithFunctionBindingsParsedSqlAlloc;
pub const lowerSetOperationPlanWithSchemasAlloc = lower_select.lowerSetOperationPlanWithSchemasAlloc;
pub const lowerSetOperationPlanWithSchemasParsedSqlAlloc = lower_select.lowerSetOperationPlanWithSchemasParsedSqlAlloc;
pub const lowerSetOperationPlanWithSchemasAndFunctionBindingsAlloc = lower_select.lowerSetOperationPlanWithSchemasAndFunctionBindingsAlloc;
pub const lowerSetOperationPlanWithSchemasAndFunctionBindingsParsedSqlAlloc = lower_select.lowerSetOperationPlanWithSchemasAndFunctionBindingsParsedSqlAlloc;
const lowerSetOperationPlanWithOptionalSourceSchemaAlloc = lower_select.lowerSetOperationPlanWithOptionalSourceSchemaAlloc;
const lowerSetOperationPlanWithOptionalSourceSchemaParsedSqlAlloc = lower_select.lowerSetOperationPlanWithOptionalSourceSchemaParsedSqlAlloc;
pub const lowerReadPlanWithCatalogAlloc = lower_select.lowerReadPlanWithCatalogAlloc;
pub const lowerReadPlanWithCatalogAndExtensionFunctionsAlloc = lower_select.lowerReadPlanWithCatalogAndExtensionFunctionsAlloc;
pub const lowerReadPlanWithCatalogAndFunctionBindingsAlloc = lower_select.lowerReadPlanWithCatalogAndFunctionBindingsAlloc;
pub const lowerReadPlanWithCatalogSessionAndFunctionBindingsAlloc = lower_select.lowerReadPlanWithCatalogSessionAndFunctionBindingsAlloc;
...
pub const lowerReadPlanWithCatalogSessionAndFunctionBindingsParsedSqlAlloc = lower_select.lowerReadPlanWithCatalogSessionAndFunctionBindingsParsedSqlAlloc;
pub const lowerReadPlanWithBoundStatementAndFunctionBindingsAlloc = lower_select.lowerReadPlanWithBoundStatementAndFunctionBindingsAlloc;
...
const lowerDocumentReadPlanFromBindingParsedSqlAlloc = lower_select.lowerDocumentReadPlanFromBindingParsedSqlAlloc;
...
pub const lowerWindowPlanAlloc = lower_select.lowerWindowPlanAlloc;
pub const lowerWindowPlanParsedSqlAlloc = lower_select.lowerWindowPlanParsedSqlAlloc;
...
pub const lowerAggregateAlloc = lower_select.lowerAggregateAlloc;
pub const lowerAggregateParsedSqlAlloc = lower_select.lowerAggregateParsedSqlAlloc;
pub const lowerAggregatePlanAlloc = lower_select.lowerAggregatePlanAlloc;
pub const lowerAggregatePlanParsedSqlAlloc = lower_select.lowerAggregatePlanParsedSqlAlloc;
pub const lowerJoinAlloc = lower_select.lowerJoinAlloc;
pub const lowerJoinParsedSqlAlloc = lower_select.lowerJoinParsedSqlAlloc;
pub const lowerJoinWithSchemasAlloc = lower_select.lowerJoinWithSchemasAlloc;
pub const lowerJoinWithSchemasParsedSqlAlloc = lower_select.lowerJoinWithSchemasParsedSqlAlloc;
pub const lowerLateralPlanAlloc = lower_select.lowerLateralPlanAlloc;
pub const lowerLateralPlanParsedSqlAlloc = lower_select.lowerLateralPlanParsedSqlAlloc;
pub const lowerLateralPlanWithSchemasAlloc = lower_select.lowerLateralPlanWithSchemasAlloc;
pub const lowerLateralPlanWithSchemasParsedSqlAlloc = lower_select.lowerLateralPlanWithSchemasParsedSqlAlloc;
