        ...
        if (kind == .ocr) {
            ...
            if (std.mem.eql(u8, route_type, "pdf")) {
                ...
                const rendered_page = render: {
                    ...
                    break :render pdf_session.?.renderPagePngAdaptiveAlloc(working_alloc, unit.page_number orelse 1, config.ocr_render_dpi, config.ocr_max_rendered_pixels, config.ocr_max_rendered_dimension);
                } catch |err| {
