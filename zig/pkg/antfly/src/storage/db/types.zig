...
pub const DensePostingMaintenanceStats = struct {
    ...
    total_segment_maintenance_runs: u64 = 0,
    total_segment_maintenance_compactions: u64 = 0,
    total_segment_maintenance_deleted_orphans: u64 = 0,
    total_segment_maintenance_deleted_temps: u64 = 0,
    ...
    last_segment_maintenance_runs: u64 = 0,
    last_segment_maintenance_compactions: u64 = 0,
    last_segment_maintenance_deleted_orphans: u64 = 0,
    last_segment_maintenance_deleted_temps: u64 = 0,
    last_segment_maintenance_manifest_segments: u64 = 0,
...
pub fn accumulateDensePostingMaintenanceStats(dst: *DensePostingMaintenanceStats, src: DensePostingMaintenanceStats) void {
    ...
    dst.total_segment_maintenance_runs += src.total_segment_maintenance_runs;
    dst.total_segment_maintenance_compactions += src.total_segment_maintenance_compactions;
    dst.total_segment_maintenance_deleted_orphans += src.total_segment_maintenance_deleted_orphans;
    dst.total_segment_maintenance_deleted_temps += src.total_segment_maintenance_deleted_temps;
    ...
    dst.last_segment_maintenance_runs = @max(dst.last_segment_maintenance_runs, src.last_segment_maintenance_runs);
    dst.last_segment_maintenance_compactions = @max(dst.last_segment_maintenance_compactions, src.last_segment_maintenance_compactions);
    dst.last_segment_maintenance_deleted_orphans = @max(dst.last_segment_maintenance_deleted_orphans, src.last_segment_maintenance_deleted_orphans);
    dst.last_segment_maintenance_deleted_temps = @max(dst.last_segment_maintenance_deleted_temps, src.last_segment_maintenance_deleted_temps);
    dst.last_segment_maintenance_manifest_segments = @max(dst.last_segment_maintenance_manifest_segments, src.last_segment_maintenance_manifest_segments);
