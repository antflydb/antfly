...
pub const OpenOptions = lifecycle.OpenOptions;
pub const OpenMode = lifecycle.OpenOptions.OpenMode;
...
pub const DerivedReplayDebtStatus = lifecycle.DerivedReplayDebtStatus;
