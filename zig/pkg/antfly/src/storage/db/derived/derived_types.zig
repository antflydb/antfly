...
pub fn cloneDerivedGraphWrite(
    alloc: Allocator,
    write: graph_edge_types.GraphEdgeWrite,
) !graph_edge_types.GraphEdgeWrite {
...
pub fn cloneDerivedGraphDelete(
    alloc: Allocator,
    delete: graph_edge_types.GraphEdgeDelete,
) !graph_edge_types.GraphEdgeDelete {
