...
pub const DB = struct {
    ...
    pub const WritePathCallbacks = struct {
        ...
        pub const collect_managed_sync_targets_for_db = derived_async_impl.collectManagedSyncTargetsForDB;
        pub const filter_managed_sync_targets_for_relational_text_search_maintenance = derived_async.filterManagedSyncTargetsForRelationalTextSearchMaintenance;
