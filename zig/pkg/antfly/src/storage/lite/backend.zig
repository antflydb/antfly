...
test "lite backend capabilities contract is stable" {
    ...
    const relational_sql_json = "\"relational\":{\"tables\":true,\"closed_schema_validation\":true,\"local_schema_rewrite_jobs\":true,\"portable_backup\":false,\"transactions\":\"local\"},\"sql\":{\"adapter\":true,\"ddl\":true,\"dml\":true,\"sessions\":true,\"document_tables\":\"read_only_planned\",\"embedded_exec\":true}";
