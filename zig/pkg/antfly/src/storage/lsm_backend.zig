...
fn activeReaderKindStats(active_readers_by_kind: [reader_pin_kind_count]usize) [reader_pin_kind_count]u64 {
    var stats: [reader_pin_kind_count]u64 = @splat(0);
...
pub const Backend = struct {
    ...
    pub const MaintenanceStats = struct {
        ...
        active_readers_by_kind: [reader_pin_kind_count]u64 = @splat(0),
        obsolete_paths_pinned_by_reader_kind: [reader_pin_kind_count]u64 = @splat(0),
    ...
    active_readers_by_kind: [reader_pin_kind_count]usize = @splat(0),
