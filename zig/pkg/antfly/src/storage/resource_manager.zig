...
pub const Slice = enum(u8) {
    ...
    dense_posting_maintenance_working_set,
    ...
    pub fn name(self: Slice) []const u8 {
        return switch (self) {
            ...
            .dense_posting_maintenance_working_set => "dense.posting_maintenance_working_set",
...
pub const ResourceManager = struct {
    ...
    pub fn snapshot(self: *ResourceManager) Stats {
        ...
        inline for (.{ Slice.lsm_block_table_cache, Slice.lsm_compaction_work, Slice.lsm_table_builder_working_set, Slice.lsm_in_memory_state, Slice.lsm_wal_write_working_set, Slice.lsm_wal_retention, Slice.lsm_recovery_working_set, Slice.hbc_node_metadata_cache, Slice.dense_search_working_set, Slice.dense_apply_working_set, Slice.dense_routing_working_set, Slice.dense_posting_maintenance_working_set, Slice.derived_replay_window, Slice.full_text_pending_segments, Slice.full_text_build_working_set, Slice.derived_backlog, Slice.text_merge_buffers, Slice.algebraic_tensor_accumulators, Slice.sparse_apply_working_set }, 0..) |slice, i| {
