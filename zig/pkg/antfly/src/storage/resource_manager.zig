...
pub const ResourceManager = struct {
    ...
    dense_member_bindings: bool = false,
    ...
    dense_exact_mapped: bool = false,
    dense_read_inline: bool = false,
    dense_read_single_helper: bool = false,
    ...
    pub fn init(options: Options) ResourceManager {
        ...
        return .{
            ...
            .dense_exact_mapped = dense_perf.enabled("ANTFLY_EXPERIMENT_EXACT_MAPPED"),
            ...
            .dense_member_bindings = dense_perf.enabled("ANTFLY_SOURCE_VECTOR_MEMBER_BINDINGS"),
            .dense_read_inline = dense_perf.enabled("ANTFLY_EXPERIMENT_VECTOR_READ_INLINE"),
            .dense_read_single_helper = dense_perf.enabled("ANTFLY_EXPERIMENT_VECTOR_READ_SINGLE_HELPER"),
