...
test "storage.hot_standby metrics derives primary gauges from status snapshot" {
...
test "storage.hot_standby metrics derives standby and promotion gauges" {
...
test "storage.hot_standby metrics derives rejoin gauges" {
...
test "storage.hot_standby metrics renders prometheus text" {
    const alloc = std.testing.allocator;
