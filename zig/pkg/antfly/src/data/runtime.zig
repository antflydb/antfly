...
pub const HealthSource = struct {
    ...
    fn writeMetrics(ptr: *anyopaque, writer: *std.Io.Writer) anyerror!void {
        ...
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_runs_total", "counter", "Dense posting maintenance passes reported by cached local runtime status", runtime_summary.dense_posting_maintenance.runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_idle_runs_total", "counter", "Dense posting maintenance passes started by idle maintenance", runtime_summary.dense_posting_maintenance.idle_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_catch_up_runs_total", "counter", "Dense posting maintenance passes started by dense catch-up session finish", runtime_summary.dense_posting_maintenance.catch_up_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_steps_total", "counter", "Dense posting maintenance work steps reported by cached local runtime status", runtime_summary.dense_posting_maintenance.total_steps);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_limit_reached_runs_total", "counter", "Dense posting maintenance passes that reported bounded posting debt remaining", runtime_summary.dense_posting_maintenance.limit_reached_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_limit_reached_indexes_total", "counter", "Dense posting maintenance indexes that reported bounded posting debt remaining", runtime_summary.dense_posting_maintenance.total_limit_reached_indexes);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_elapsed_ns_total", "counter", "Total dense posting maintenance elapsed nanoseconds reported by cached local runtime status", runtime_summary.dense_posting_maintenance.total_elapsed_ns);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_segment_runs_total", "counter", "Posting segment backend maintenance runs reported by cached local runtime status", runtime_summary.dense_posting_maintenance.total_segment_maintenance_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_segment_compactions_total", "counter", "Posting segment backend compactions reported by cached local runtime status", runtime_summary.dense_posting_maintenance.total_segment_maintenance_compactions);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_segment_deleted_orphans_total", "counter", "Posting segment backend orphan segment files deleted by cached local runtime status", runtime_summary.dense_posting_maintenance.total_segment_maintenance_deleted_orphans);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_segment_deleted_temps_total", "counter", "Posting segment backend temporary files deleted by cached local runtime status", runtime_summary.dense_posting_maintenance.total_segment_maintenance_deleted_temps);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_max_elapsed_ns", "gauge", "Largest dense posting maintenance pass duration reported by cached local runtime status", runtime_summary.dense_posting_maintenance.max_elapsed_ns);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_max_indexes_total", "counter", "Dense posting maintenance passes stopped by the max-index budget", runtime_summary.dense_posting_maintenance.budget_stop_max_indexes_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_elapsed_total", "counter", "Dense posting maintenance passes stopped by the elapsed-time budget", runtime_summary.dense_posting_maintenance.budget_stop_elapsed_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_resource_total", "counter", "Dense posting maintenance passes stopped by the resource-manager budget", runtime_summary.dense_posting_maintenance.budget_stop_resource_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_convergence_limit_total", "counter", "Dense posting maintenance idle runs that reached the convergence pass limit with bounded posting debt still remaining", runtime_summary.dense_posting_maintenance.convergence_limit_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_steps", "gauge", "Largest last-pass dense posting maintenance step count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_steps);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_limit_reached_indexes", "gauge", "Largest last-pass dense posting maintenance index count reporting bounded debt remaining", runtime_summary.dense_posting_maintenance.last_limit_reached_indexes);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_remaining_dirty_postings", "gauge", "Largest last-pass remaining dirty posting count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_remaining_dirty_postings);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_remaining_delta_tail_postings", "gauge", "Largest last-pass remaining delta-tail posting count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_remaining_delta_tail_postings);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_remaining_overfull_postings", "gauge", "Largest last-pass remaining overfull posting count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_remaining_overfull_postings);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_remaining_postings_at_capacity", "gauge", "Largest last-pass remaining at-capacity posting count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_remaining_postings_at_capacity);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_max_remaining_over_capacity_members", "gauge", "Largest last-pass over-capacity member count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_max_remaining_over_capacity_members);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_segment_manifest_segments", "gauge", "Largest last-pass posting segment manifest segment count among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_segment_maintenance_manifest_segments);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_last_elapsed_ns", "gauge", "Largest last-pass dense posting maintenance elapsed nanoseconds among cached local runtime statuses", runtime_summary.dense_posting_maintenance.last_elapsed_ns);
...
test "data server pulls and applies HA standby replication through internal HTTP client" {
    const alloc = std.testing.allocator;
    const FakeStatus = struct {
        fn iface() antfly.public_api.http_server.StatusSource {
            return .{
    ...
    var server = DataServer.initFromLocalMetadataSources(alloc, .{
        ...
        .ha = .{
            ...
            .standby_replication = .{
                .upstream_base_uri = "http://primary.internal.test",
                .slot_name = "standby-a",
                .executor = failing_executor.executor(),
            },
        },
    }, FakeCatalog.iface(), FakeStatus.iface());
    defer server.deinit();
