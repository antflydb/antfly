...
pub const HealthSource = struct {
    ...
    fn writeMetrics(ptr: *anyopaque, writer: *std.Io.Writer) anyerror!void {
        ...
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_runs_total", "counter", "Dense posting maintenance scheduler passes reported by cached local runtime status", runtime_summary.dense_posting_maintenance.runs);
        ...
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_limit_reached_runs_total", "counter", "Dense posting maintenance scheduler passes that reported bounded posting debt remaining", runtime_summary.dense_posting_maintenance.limit_reached_runs);
        ...
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_elapsed_ns_total", "counter", "Total dense posting maintenance scheduler elapsed nanoseconds reported by cached local runtime status", runtime_summary.dense_posting_maintenance.total_elapsed_ns);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_max_elapsed_ns", "gauge", "Largest dense posting maintenance scheduler pass duration reported by cached local runtime status", runtime_summary.dense_posting_maintenance.max_elapsed_ns);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_max_indexes_total", "counter", "Dense posting maintenance scheduler passes stopped by the max-index budget", runtime_summary.dense_posting_maintenance.budget_stop_max_indexes_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_elapsed_total", "counter", "Dense posting maintenance scheduler passes stopped by the elapsed-time budget", runtime_summary.dense_posting_maintenance.budget_stop_elapsed_runs);
        try health_metrics.appendPromMetric(writer, "antfly_data_dense_posting_maintenance_budget_stop_resource_total", "counter", "Dense posting maintenance scheduler passes stopped by the resource-manager budget", runtime_summary.dense_posting_maintenance.budget_stop_resource_runs);
