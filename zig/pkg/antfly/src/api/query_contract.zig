...
fn expectSortProfileDiagnosticsSerializationForTest() !void {
    ...
    try std.testing.expectEqualStrings("doc_nums", sort.get("native_filter_mode").?.string);
    ...
    try std.testing.expectEqual(@as(i64, 5), sort.get("admitted_count").?.integer);
    try std.testing.expectEqual(@as(i64, 2), sort.get("replaced_count").?.integer);
    try std.testing.expectEqual(@as(i64, 3), sort.get("discarded_count").?.integer);
    try std.testing.expectEqual(@as(i64, 2), sort.get("selected_count").?.integer);
    try std.testing.expectEqual(@as(i64, 11), sort.get("decorate_us").?.integer);
    try std.testing.expectEqual(@as(i64, 13), sort.get("native_doc_value_load_us").?.integer);
    ...
    try std.testing.expectEqual(@as(i64, 23), sort.get("stored_json_load_us").?.integer);
    try std.testing.expectEqual(@as(i64, 29), sort.get("stored_json_load_count").?.integer);
    try std.testing.expectEqual(@as(i64, 31), sort.get("projected_source_load_us").?.integer);
    try std.testing.expectEqual(@as(i64, 37), sort.get("projected_source_load_count").?.integer);
    try std.testing.expectEqual(@as(i64, 31), sort.get("final_sort_us").?.integer);
...
fn buildSortProfileValue(
    ...
    try sort.put(alloc, "native_filter_mode", .{ .string = profile.native_filter_mode });
    ...
    try sort.put(alloc, "replaced_count", try buildProfileUnsignedValue(alloc, profile.replaced_count));
    try sort.put(alloc, "discarded_count", try buildProfileUnsignedValue(alloc, profile.discarded_count));
    try sort.put(alloc, "selected_count", try buildProfileUnsignedValue(alloc, profile.selected_count));
    try sort.put(alloc, "decorate_us", try buildProfileUnsignedValue(alloc, profile.decorate_us));
    try sort.put(alloc, "native_doc_value_load_us", try buildProfileUnsignedValue(alloc, profile.native_doc_value_load_us));
    try sort.put(alloc, "native_doc_value_hit_count", try buildProfileUnsignedValue(alloc, profile.native_doc_value_hit_count));
    ...
    try sort.put(alloc, "window_len", try buildProfileSizeValue(alloc, profile.window_len));
    try sort.put(alloc, "collector_heap_peak", try buildProfileSizeValue(alloc, profile.collector_heap_peak));
