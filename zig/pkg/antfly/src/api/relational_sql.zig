...
fn mergeDataModifyingCteKindCount(
    ctes: []const sql_adapter.LoweredDataModifyingCte,
...
fn mergeDataModifyingCteReturningCount(ctes: []const sql_adapter.LoweredDataModifyingCte) usize {
    var count: usize = 0;
    for (ctes) |cte| {
...
fn mergeDataModifyingCteClaimPlaceholderCount(ctes: []const sql_adapter.LoweredDataModifyingCte) usize {
    var count: usize = 0;
    for (ctes) |cte| {
