...
test "managed strict terminal coverage does not fabricate replay debt" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, encoded, "\"replay_catch_up_required\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, encoded, "\"backfill_active\":false") != null);
    try std.testing.expect(std.mem.indexOf(u8, encoded, "\"backfill_state\":\"failed\"") != null);
    try std.testing.expect(std.mem.indexOf(u8, encoded, "coverage policy unsatisfied") != null);
