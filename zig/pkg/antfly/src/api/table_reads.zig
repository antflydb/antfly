...
fn mapDenseSearchProfile(profile: db_query_search.DenseSearchProfile) query_api.QueryResponseMeta.DenseSearchProfile {
    return .{
        ...
        .hbc_search_scratch_allocations = profile.hbc_search_scratch_allocations,
        .hbc_search_scratch_allocation_bytes = profile.hbc_search_scratch_allocation_bytes,
        .hbc_search_scratch_retained_bytes = profile.hbc_search_scratch_retained_bytes,
        ...
        .hbc_posting_overlay_ns = profile.hbc_posting_overlay_ns,
        .hbc_posting_overlay_calls = profile.hbc_posting_overlay_calls,
        ...
        .hbc_posting_overlay_fallbacks = profile.hbc_posting_overlay_fallbacks,
        .hbc_posting_overlay_cache_hits = profile.hbc_posting_overlay_cache_hits,
        .hbc_posting_overlay_cache_misses = profile.hbc_posting_overlay_cache_misses,
        .hbc_posting_overlay_cache_evictions = profile.hbc_posting_overlay_cache_evictions,
        .hbc_posting_overlay_cache_admission_skips = profile.hbc_posting_overlay_cache_admission_skips,
        .hbc_posting_overlay_cache_member_bytes = profile.hbc_posting_overlay_cache_member_bytes,
        .hbc_centroid_directory_blocks_scanned = profile.hbc_centroid_directory_blocks_scanned,
        .hbc_centroid_directory_blocks_selected = profile.hbc_centroid_directory_blocks_selected,
        .hbc_centroid_directory_block_centroids_scored = profile.hbc_centroid_directory_block_centroids_scored,
        .hbc_centroid_directory_posting_centroids_scored = profile.hbc_centroid_directory_posting_centroids_scored,
