...
const SqlValue = relational_sql.SqlValue;
const LoweredDdlPlan = relational_sql.LoweredDdlPlan;
const LoweredExplainPlan = relational_sql.LoweredExplainPlan;
const LoweredReadPlan = relational_sql.LoweredReadPlan;
const LoweredWritePlan = relational_sql.LoweredWritePlan;
const MergeExecutionTargetRow = relational_sql.MergeExecutionTargetRow;
...
const applyDdlPlanToSchemaJsonAlloc = relational_sql.applyDdlPlanToSchemaJsonAlloc;
const buildMergeMutationBatchAlloc = relational_sql.buildMergeMutationBatchAlloc;
const buildMergeMutationBatchFromDbAcrossRangesAlloc = relational_sql.buildMergeMutationBatchFromDbAcrossRangesAlloc;
const buildMergeMutationBatchFromDbsAcrossRangesAlloc = relational_sql.buildMergeMutationBatchFromDbsAcrossRangesAlloc;
const bulkSqlIoExecutionFingerprintAlloc = sql_adapter.bulkSqlIoExecutionFingerprintAlloc;
const bulkSqlIoExecutionPlanFromDdlPlan = relational_sql.bulkSqlIoExecutionPlanFromDdlPlan;
...
const lowerDeleteParsedSqlAlloc = relational_sql.lowerDeleteParsedSqlAlloc;
const lowerDdlPlanParsedSqlAlloc = sql_adapter.lowerDdlPlanParsedSqlAlloc;
const lowerDeleteJoinedMutationSourceWithSchemasAlloc = relational_sql.lowerDeleteJoinedMutationSourceWithSchemasAlloc;
const lowerDeleteJoinedMutationSourceWithSchemasParsedSqlAlloc = relational_sql.lowerDeleteJoinedMutationSourceWithSchemasParsedSqlAlloc;
const lowerExplainPlanWithOptionsCatalogAndFunctionBindingsParsedSqlAlloc = relational_sql.lowerExplainPlanWithOptionsCatalogAndFunctionBindingsParsedSqlAlloc;
const lowerInsertWithResolverParsedSqlAlloc = relational_sql.lowerInsertWithResolverParsedSqlAlloc;
const lowerInsertWithResolverStrictParsedSqlAlloc = relational_sql.lowerInsertWithResolverStrictParsedSqlAlloc;
const lowerMergeMutationPlanParsedSqlAlloc = relational_sql.lowerMergeMutationPlanParsedSqlAlloc;
const lowerQueryPlanWithFunctionBindingsParsedSqlAlloc = relational_sql.lowerQueryPlanWithFunctionBindingsParsedSqlAlloc;
const lowerReadPlanAlloc = relational_sql.lowerReadPlanAlloc;
const lowerReadPlanWithCatalogAndFunctionBindingsParsedSqlAlloc = relational_sql.lowerReadPlanWithCatalogAndFunctionBindingsParsedSqlAlloc;
const lowerReadPlanWithCatalogAlloc = relational_sql.lowerReadPlanWithCatalogAlloc;
const lowerReadPlanWithFunctionBindingsParsedSqlAlloc = relational_sql.lowerReadPlanWithFunctionBindingsParsedSqlAlloc;
const lowerRelationPopulationPlanWithCatalogAndFunctionBindingsParsedSqlAlloc = relational_sql.lowerRelationPopulationPlanWithCatalogAndFunctionBindingsParsedSqlAlloc;
const lowerSelectParsedSqlAlloc = relational_sql.lowerSelectParsedSqlAlloc;
const lowerUpdateJoinedMutationSourceWithSchemasAlloc = relational_sql.lowerUpdateJoinedMutationSourceWithSchemasAlloc;
const lowerUpdateJoinedMutationSourceWithSchemasParsedSqlAlloc = relational_sql.lowerUpdateJoinedMutationSourceWithSchemasParsedSqlAlloc;
const lowerUpdateMutationSourceParsedSqlAlloc = relational_sql.lowerUpdateMutationSourceParsedSqlAlloc;
const lowerUpdateParsedSqlAlloc = relational_sql.lowerUpdateParsedSqlAlloc;
const lowerUpdateStrictParsedSqlAlloc = relational_sql.lowerUpdateStrictParsedSqlAlloc;
const lowerWritePlanAlloc = relational_sql.lowerWritePlanAlloc;
const lowerWritePlanWithCatalogAlloc = relational_sql.lowerWritePlanWithCatalogAlloc;
const lowerWritePlanWithCatalogParsedSqlAlloc = relational_sql.lowerWritePlanWithCatalogParsedSqlAlloc;
const lowerWritePlanParsedSqlAlloc = relational_sql.lowerWritePlanParsedSqlAlloc;
const sequenceOptionCount = sql_adapter.sequenceOptionCount;
const preparedTransactionRecoveryIntentFromPlan = relational_sql.preparedTransactionRecoveryIntentFromPlan;
const preparedTransactionRecoveryFingerprintAlloc = relational_sql.preparedTransactionRecoveryFingerprintAlloc;
