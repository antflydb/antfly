...
const sql_adapter_runtime = @import("sql_adapter_runtime.zig");
...
const LoweredDdlPlan = sql_adapter.LoweredDdlPlan;
...
const lowerDdlPlanParsedSqlAlloc = sql_adapter.lowerDdlPlanParsedSqlAlloc;
