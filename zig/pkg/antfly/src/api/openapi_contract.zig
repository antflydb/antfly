...
test "public openapi contract module is generated and wired" {
    ...
    try std.testing.expect(@hasField(generated.SortProfile, "order_by"));
    try std.testing.expect(@hasField(generated.SortProfile, "cursor"));
    try std.testing.expect(@hasField(generated.SortProfile, "exactness"));
    try std.testing.expect(@hasField(generated.SortProfile, "source"));
    try std.testing.expect(@hasField(generated.SortProfile, "candidate_source"));
    ...
    try std.testing.expect(@hasField(generated.SortProfile, "sorted_segment_executor_available"));
    try std.testing.expect(@hasField(generated.SortProfile, "sorted_segment_bounds_available"));
    try std.testing.expect(@hasField(generated.SortProfile, "sorted_segment_scanned_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "sorted_segment_scan_budget"));
    ...
    try std.testing.expect(@hasField(generated.SortProfile, "admitted_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "replaced_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "discarded_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "selected_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "decorate_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "native_doc_value_load_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "native_doc_value_hit_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "native_doc_value_miss_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "stored_json_load_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "stored_json_load_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "projected_source_load_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "projected_source_load_count"));
    try std.testing.expect(@hasField(generated.SortProfile, "final_sort_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "total_us"));
    try std.testing.expect(@hasField(generated.SortProfile, "window_capacity"));
    try std.testing.expect(@hasField(generated.SortProfile, "window_len"));
