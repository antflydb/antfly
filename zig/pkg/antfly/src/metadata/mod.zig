...
pub const PackageManifest = extensions.PackageManifest;
pub const PackageStoreEntry = extensions.PackageStoreEntry;
pub const InstallManifest = extensions.InstallManifest;
...
pub const DropExtensionRequest = extensions.DropExtensionRequest;
pub const ConfigureExtensionRequest = extensions.ConfigureExtensionRequest;
pub const InstallPlan = extensions.InstallPlan;
pub const ExtensionCatalog = extensions.ExtensionCatalog;
pub const ExtensionScope = extensions.ExtensionScope;
pub const ExtensionObjectKind = extensions.ExtensionObjectKind;
pub const scanPackageStoreAlloc = extensions.scanPackageStoreAlloc;
pub const freePackageStoreEntries = extensions.freePackageStoreEntries;
...
test "metadata module compiles" {
    ...
    _ = ExtensionMember;
    _ = ExtensionDependency;
    _ = InstallExtensionRequest;
    _ = UpdateExtensionRequest;
    _ = DropMode;
    _ = DropExtensionRequest;
    _ = ConfigureExtensionRequest;
    _ = InstallPlan;
    _ = ExtensionCatalog;
    _ = ExtensionScope;
    _ = ExtensionObjectKind;
    _ = scanPackageStoreAlloc;
    _ = freePackageStoreEntries;
    _ = captureAdminSnapshot;
    _ = freeAdminSnapshot;
    _ = ActiveTransitionCounts;
    _ = ActiveTransitions;
    _ = findAdminTable;
    _ = findAdminRange;
    _ = findAdminStore;
    _ = countActiveAdminTransitions;
    _ = listAdminTableRanges;
    _ = listAdminGroupPlacement;
    _ = listAdminActiveTransitions;
    _ = freeAdminRangeRefs;
    _ = freeAdminPlacementRefs;
    _ = freeAdminActiveTransitions;
    _ = CapturedCurrentState;
    _ = MetadataState;
    _ = TableRecord;
    _ = PlacementClass;
    _ = RangeRecord;
    ...
    _ = StoreStatusReport;
    _ = StoreObservation;
    _ = PlacementStatusTag;
    _ = PlacementStatus;
    _ = ReconcileLeaseRecord;
    _ = ReconcileLeaseState;
    _ = ReconcileLeaseStats;
    _ = ReplicationSourceStatusRecord;
    _ = ShuffleJoinLeaseRecord;
    _ = applyStoreObservation;
    _ = applyStoreObservations;
    _ = classifyStore;
    _ = SplitIntent;
    _ = MergeIntent;
    _ = TableManager;
    _ = TableProvisionSummary;
    _ = ReconcileReplicaRootOptions;
    _ = ShardDbAdapter;
    _ = FallbackLocalShardDbAdapter;
    _ = groupDbPathFromReplicaRoot;
    _ = reconcileReplicaRootTables;
    _ = reconcileReplicaRootTablesWithOptions;
    _ = parsePlacementClass;
    _ = placementRoleCompatible;
    _ = TransitionKind;
    _ = TransitionPhase;
    ...
    _ = SplitRuntimeObservation;
    _ = MergeRuntimeObservation;
    _ = CurrentMetadataState;
    _ = PlannedSplitStep;
    _ = PlannedMergeStep;
    _ = ReconciliationPlan;
    _ = Reconciler;
    _ = ReconcileSummary;
    _ = MetadataControlLoop;
    _ = TransitionAction;
    ...
    _ = MetadataTransitionRuntime;
    _ = TransitionStepResult;
    _ = TransitionDriver;
}
