...
pub const ReconcileSummary = struct {
    ...
    unique_constraint_range_upserts: usize = 0,
    secondary_index_rebuild_range_upserts: usize = 0,
    ...
    foreign_key_ref_range_removals: usize = 0,
    unique_constraint_range_removals: usize = 0,
    secondary_index_rebuild_range_removals: usize = 0,
...
pub const MetadataControlLoop = struct {
    ...
    pub fn reconcilePrepared(self: *MetadataControlLoop, service: anytype) !ReconcileSummary {
        ...
        const summary: ReconcileSummary = .{
            ...
            .foreign_key_ref_range_upserts = plan.foreign_key_ref_range_upserts.len,
            .unique_constraint_range_upserts = plan.unique_constraint_range_upserts.len,
            .secondary_index_rebuild_range_upserts = plan.secondary_index_rebuild_range_upserts.len,
            ...
            .foreign_key_ref_range_removals = plan.foreign_key_ref_range_removals.len,
            .unique_constraint_range_removals = plan.unique_constraint_range_removals.len,
            .secondary_index_rebuild_range_removals = plan.secondary_index_rebuild_range_removals.len,
