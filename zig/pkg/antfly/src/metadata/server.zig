...
pub const MetadataServer = struct {
    ...
    pub fn init(
        ...
        service_cfg.internal_service_secret = cfg.api_server_cfg.trusted_principal_secret;
        service_cfg.internal_service_issuer = cfg.api_server_cfg.trusted_principal_issuer;
        ...
        if (cfg.admin_listener) |listener_cfg| {
            ...
            _ = public_write_source.withInternalServiceAuth(
                cfg.api_server_cfg.trusted_principal_secret,
                cfg.api_server_cfg.trusted_principal_issuer,
            );
