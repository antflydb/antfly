...
pub const Status = enum(u32) {
    ...
    admission_full = 532,
    admission_queue_full = 533,
    admission_bytes_exhausted = 534,
    admission_request_too_large = 535,
    admission_wait_timeout = 536,
    admission_closed = 537,
    native_backup_repair_state_not_quiescent = 538,
    // Restricted completion structural eligibility; append-only wire values.
    prepared_completion_active = 539,
    ...
    recovery_required = 568,
    invalid_txn_record = 569,
    completion_admission_unavailable = 570,
    completion_admission_policy_changed = 571,
    missing_completion_admission_guard = 572,
    invalid_completion_catalog = 573,
    pre_decision_not_proposed = 574,
    invalid_participant = 575,
};
