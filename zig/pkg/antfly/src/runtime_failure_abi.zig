...
pub const Status = enum(u32) {
    ...
    catalog_already_exists = 495,
    catalog_command_too_large = 496,
    catalog_generation_changed = 497,
    catalog_id_exhausted = 498,
    catalog_not_found = 499,
    catalog_projection_refresh_required = 500,
    catalog_routing_snapshot_timeout = 501,
    catalog_table_topology_required = 502,
    create_table_request_too_large = 503,
    database_not_empty = 504,
    database_not_found = 505,
    forbidden = 506,
    invalid_catalog_mutation = 507,
    invalid_catalog_name = 508,
    invalid_catalog_record = 509,
    invalid_catalog_route_fence = 510,
    invalid_metadata_node_id = 511,
    invalid_store_reporter_fence = 512,
    invalid_tablespace_location = 513,
    invalid_tablespace_placement_policy = 514,
    metadata_incarnation_mismatch = 515,
    metadata_incarnation_unavailable = 516,
    metadata_mutation_outcome_unknown = 517,
    metadata_snapshot_head_mismatch = 518,
    namespace_not_empty = 519,
    namespace_not_found = 520,
    not_leader = 521,
    protected_catalog_resource = 522,
    resource_request_too_large = 523,
    store_report_base_mismatch = 524,
    table_already_exists = 525,
    table_topology_protocol_upgrade_required = 526,
    tablespace_in_use = 527,
    tablespace_not_found = 528,
    ha_seed_snapshot_runtime_busy = 529,
    ha_seed_capture_already_in_progress = 530,
};
