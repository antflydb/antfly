...
pub const Status = enum(u32) {
    ...
    catalog_already_exists = 493,
    catalog_command_too_large = 494,
    catalog_generation_changed = 495,
    catalog_id_exhausted = 496,
    catalog_not_found = 497,
    catalog_projection_refresh_required = 498,
    catalog_routing_snapshot_timeout = 499,
    catalog_table_topology_required = 500,
    create_table_request_too_large = 501,
    database_not_empty = 502,
    database_not_found = 503,
    forbidden = 504,
    invalid_catalog_mutation = 505,
    invalid_catalog_name = 506,
    invalid_catalog_record = 507,
    invalid_catalog_route_fence = 508,
    invalid_metadata_node_id = 509,
    invalid_store_reporter_fence = 510,
    invalid_tablespace_location = 511,
    invalid_tablespace_placement_policy = 512,
    metadata_incarnation_mismatch = 513,
    metadata_incarnation_unavailable = 514,
    metadata_mutation_outcome_unknown = 515,
    metadata_snapshot_head_mismatch = 516,
    namespace_not_empty = 517,
    namespace_not_found = 518,
    not_leader = 519,
    protected_catalog_resource = 520,
    resource_request_too_large = 521,
    store_report_base_mismatch = 522,
    table_already_exists = 523,
    table_topology_protocol_upgrade_required = 524,
    tablespace_in_use = 525,
    tablespace_not_found = 526,
    ha_seed_snapshot_runtime_busy = 527,
    ha_seed_capture_already_in_progress = 528,
};
