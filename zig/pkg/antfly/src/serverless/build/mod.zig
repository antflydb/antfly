...
pub const lake_graph_metric = @import("lake_graph_metric.zig");
...
pub const reconcileResolvedExternalLakeSidecarsWithCancellationAlloc = lake_rebuild.reconcileResolvedExternalSourceSidecarsWithCancellationAlloc;
...
pub const LakeGraphMetricBuildLimits = lake_graph_metric.Limits;
pub const LakeGraphMetricBuildOptions = lake_graph_metric.BuildOptions;
pub const LakeGraphMetricBuildResult = lake_graph_metric.BuildResult;
pub const default_graph_metric_compute_parallelism = lake_graph_metric.default_compute_parallelism;
pub const max_graph_metric_compute_parallelism = lake_graph_metric.max_compute_parallelism;
pub const buildLakeGraphMetricFromGraphPayloadAlloc = lake_graph_metric.buildFromGraphPayloadAlloc;
pub const publishLakeGraphMetricFromGraphPayloadAlloc = lake_graph_metric.publishFromGraphPayloadAlloc;
...
test "serverless build module compiles" {
    ...
    _ = reconcileResolvedExternalLakeSidecarsWithRuntimeAlloc;
    ...
    _ = LakeGraphMetricBuildLimits;
    _ = LakeGraphMetricBuildOptions;
