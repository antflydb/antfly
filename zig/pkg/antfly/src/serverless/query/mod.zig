...
pub const clearLastGraphMetricRejectionDiagnostic = graph_metric_reader.clearLastRejectionDiagnostic;
pub const peekLastGraphMetricRejectionDiagnostic = graph_metric_reader.peekLastRejectionDiagnostic;
