...
// Tiled matrix multiplication with B transposed and Q8_1 dequantization.
// C[M,N] = A[M,K] @ dequant(B_q8_1)^T
...
fn dequant_q8_1(b_row: u32, k_abs: u32) -> f32 {
    ...
    for (var t = 0u; t < num_tiles; t++) {
        ...
        for (var pass = 0u; pass < 2u; pass++) {
            ...
            if (g_col < params.N && g_k < params.K) {
                tile_b[idx] = dequant_q8_1(g_col, g_k);
            } else {
                tile_b[idx] = 0.0;
            }
        }
