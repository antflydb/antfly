...
5. Complete sidecar builders over real external row refs: full-text, dense
   ...
   row-ref-compatible rebuild bindings. Remaining work is to add broader
   algebraic planner-derived build specs and invoke the executor plus manifest
   reconciler from reconcile/operator workflows.
