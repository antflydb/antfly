...
1. Finish production public catalog routing: harden the installed
   ...
   pinning, durable manifest/state recording, explainable pinned state, and
   broader fixture-backed route coverage for cloud URI shapes.
