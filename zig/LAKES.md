...
6. Finish production freshness and cache policy: produce candidate sets from
   concrete text/vector/sparse/graph query operators, pass those candidate sets
   into public row-query/aggregate routing and public explain, broaden exact
   ...
   persistent cache storage, and extend
