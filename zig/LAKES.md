...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, add the catalog/runtime
   resolver that turns `.current` external bindings into resolved inventory
   publication plans during live publication, and add broader fixture-backed
