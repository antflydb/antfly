...
2. Broaden the Parquet reader beyond the first flat i64/i32/f32/f64/byte-array
   and INT96 timestamp paths: logical TIMESTAMP annotations, decimals, nested
