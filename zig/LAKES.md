...
1. Finish production public catalog routing: harden the installed
   ...
   fixture-backed route coverage for predicates, credentials, and cloud URI
   shapes.
