...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, attach durable external
   inventory manifest plans to live table publication, and add broader
