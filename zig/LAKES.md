...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, source snapshot pinning,
   durable manifest/state recording, explainable pinned state, and broader
   fixture-backed route coverage for credentials and cloud URI shapes.
