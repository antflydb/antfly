...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, connect the catalog
   publication resolver to the configured credential resolver for credentialed
   sources, and add broader fixture-backed
   route coverage for cloud URI shapes.
