...
6. Finish production freshness and cache policy: route public queries through
   ...
   execution beyond the current helper contract, isolate metadata/footer cache
   from decoded broad-scan scratch, and add retry/checksum behavior for
