...
4. Implement Iceberg metadata and manifest expansion: metadata JSON refresh,
   ...
   pruning, structured delete-file planning, row-level position/equality delete application, and schema evolution checks.
