...
6. Finish production freshness and cache policy: route public queries through
   ...
   deployment-specific budgets for the owned serving cache option in
   runtime/public lake routing, add persistent cache storage, and add checksum
