...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, durable source snapshot
   pinning, durable manifest/state recording, and broader fixture-backed route
