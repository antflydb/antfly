...
6. Finish production freshness and cache policy: the text, sparse, dense
   ...
   values for the public serving-cache budget, extend persisted cache checksum
   provenance to object-store checksum
