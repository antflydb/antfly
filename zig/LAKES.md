...
6. Finish production freshness and cache policy: route public queries through
   ...
   sidecar candidate execution beyond the current helper contract, instantiate
   the named serving cache policy from runtime/public lake routing with
   deployment-specific budgets, add persistent cache storage, and add checksum
