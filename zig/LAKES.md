...
4. Finish Iceberg delete and evolution correctness: metadata JSON refresh,
   ...
   field IDs. The remaining work is to broaden equality deletes to
   nested/complex fields, tighten real-provider version/ETag fixtures, and add
   field-ID-aware schema evolution for rename/reorder/nested read compatibility.
