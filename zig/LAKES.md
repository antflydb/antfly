...
4. Finish Iceberg delete and evolution correctness: metadata JSON refresh,
   ...
   remaining work is to read active position-delete Parquet files into the
   tested row-ref mapper, pass those refs through the common `lake_rows`
