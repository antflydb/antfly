...
6. Finish production freshness and cache policy: the text, sparse, dense
   ...
   selection would be ambiguous. Remaining work is to invoke those producers
   from public query/explain operators with a real artifact-store handle, feed
