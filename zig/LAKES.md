...
4. Finish Iceberg delete and evolution correctness: metadata JSON refresh,
   ...
   tighten real-provider version/ETag fixtures, and complete schema evolution
   checks.
