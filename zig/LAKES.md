...
6. Finish production freshness and cache policy: the text, sparse, dense
   ...
   values for the public serving-cache budget, and compare provider-native
   content checksums for partial range responses if providers surface
