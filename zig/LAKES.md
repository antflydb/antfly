...
6. Finish production freshness and cache policy: the text, sparse, dense
   ...
   content checksums if the object-store abstraction starts surfacing checksum
   headers in addition to ETag/version identity.
