...
1. Finish production public catalog routing: harden the installed
   ...
   path with production S3/GCS credential behavior, wire the catalog publication
   resolver seam to the object-store/credential resolver that turns `.current`
   external bindings into resolved inventory publication plans during live
   publication, and add broader fixture-backed
