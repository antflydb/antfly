...
1. Finish production public catalog routing: harden the installed
   ...
   durable manifest/state recording, explainable pinned state, and successful
   fixture-backed route coverage.
