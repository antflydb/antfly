...
6. Finish production freshness and cache policy: the text, sparse, dense
   ...
   row-query/aggregate routing and public explain, tune deployment-specific
   values above the conservative public serving-cache default, and compare provider-native
