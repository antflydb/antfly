...
METADATA_SPEC = ROOT / "pkg/antfly/src/metadata/openapi.yaml"
USERMGR_SPEC = ROOT / "pkg/antfly/src/usermgr/openapi.yaml"
...
PATH_REWRITES = {
    "../../antfly/": "../",
    "../antfly/": "../",
    "../metadata/": "pkg/antfly/src/metadata/",
    "../usermgr/": "pkg/antfly/src/usermgr/",
}
