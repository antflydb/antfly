...
pub fn build(b: *std.Build) void {
    ...
    const lib_data_storage_default_filters = [_][]const u8{
        ...
        "persistent replica state migrates legacy checkpoints atomically",
    ...
    const lib_api_storage_authority_tests = b.addTest(.{
        ...
        .filters = &.{
            ...
            "cluster reservation cleanup cannot release another attempt owner",
            "attempt head ordering ignores producer wall clocks and journal scans",
            "newest attempt health rejects same-size artifact corruption",
            ...
            "stale uncommitted cluster backup attempt is retained without lease authority",
