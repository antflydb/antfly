...
pub fn build(b: *std.Build) void {
    ...
    const lib_unit_default_filters = [_][]const u8{
        ...
        "complete graph match anchors retain admission and discard retrieval shaping",
        "complete graph match anchor scan conjoins authorization with selected anchor union",
        ...
        "legacy graph result refs normalize to the ranked query result",
