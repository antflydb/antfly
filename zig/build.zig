...
pub fn build(b: *std.Build) void {
    ...
    const api_transactions_docid_tests = b.addTest(.{
        ...
        .filters = &.{
            ...
            "DistributedEntitySink transactional promotion batch prefers stateless batch commit",
            "DistributedEntitySink batch commit remains compatible with transaction-only sources",
            "DistributedEntitySink transactional mode falls back to batch when unsupported",
