...
pub fn build(b: *std.Build) void {
    ...
    const search_performance_tests = b.addTest(.{
        ...
        .filters = &.{
            ...
            "term doc frequency invalidates on real deletes and reconciles sparse tombstones",
            "retained snapshots observe shared deletion epochs and live BM25 aggregates",
