...
pub fn build(b: *std.Build) void {
    ...
    const lib_unit_default_filters = [_][]const u8{
        ...
        "graph coordinator distinct merge honors configured limits and records the exhausted dimension",
        "incremental graph merge enforces distinct identities across released shards",
        "graph coordinator admits list capacity and ownership transfer before allocation",
