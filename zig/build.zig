...
pub fn build(b: *std.Build) void {
    ...
    extraction_openapi_mod.addImport("antfly_ai_messages_openapi", ai_messages_openapi_mod);
    ...
    termite_api_mod.addImport("antfly_extraction_openapi", extraction_openapi_mod);
