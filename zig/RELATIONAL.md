...
predicate branches, plus proven-disjoint scalar, scalar OR, and expression
...
8. **CTEs and materialized stream bounds.**
   ...
   duplicate-preserving SQL result matches the row-query result. Numeric range
