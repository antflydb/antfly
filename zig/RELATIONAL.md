...
schema-namespace catalog, and extension catalog plan containers, with the
remaining DDL families scheduled to move through the same facade as their
lowerers are extracted;
