...
8. **CTEs and materialized stream bounds.**
   ...
   group unless that branch also has expression predicates. A right-branch
   expression OR lowers to one `expression_not_predicates` entry per branch. Numeric range
