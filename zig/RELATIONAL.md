...
`CREATE INDEX ... INCLUDE (...)` on ordinary btree secondary indexes.
...
columns that do not exist or that repeat key columns. Unique, GIN, and generated
