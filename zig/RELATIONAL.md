...
names are captured as typed bulk-I/O metadata so import/export validation can
normalize or transcode before row decoding. The production shape should stream
...
force-quote/force-null column policies have
