...
8. **CTEs and materialized stream bounds.**
   ...
   Scalar `IN` plus expression-predicate `UNION ALL` branches lower through
   ...
   or the expanded typed expression branches contain same-expression
   contradictions for every branch pair.
