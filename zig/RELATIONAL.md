...
quote byte, and escape byte, then fails closed when applied to table schema or
runtime storage. The production shape should stream rows through typed schema
