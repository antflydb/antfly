...
metadata instead of remaining unsupported SQL. Execution still rejects identity
reset and generation-changing truncate work until the durable catalog-owned
table-emptying job can claim all affected owner ranges, reset owned allocators,
and promote table generations atomically.
