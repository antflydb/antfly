...
- Implemented: fail-closed SQL boundary parsing for the supported PostgreSQL-shaped
  ...
  including `COALESCE`, `LOWER`, `UPPER`, `TRIM` / `BTRIM` / `LTRIM` / `RTRIM`, `REPLACE`, `REGEXP_REPLACE`, `REGEXP_COUNT`, `REGEXP_INSTR`, `REGEXP_SUBSTR`, `LENGTH`, searched `CASE`, `NULLIF`, `GREATEST`, `LEAST`, `ABS`, `ROUND`, `FLOOR`, `CEIL`, casts,
