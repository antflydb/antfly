...
non-negated `IN` plus expression-predicate `EXCEPT` branches. `INTERSECT`
...
8. **CTEs and materialized stream bounds.**
   ...
   preserving branch multiplicity. `INTERSECT` appends compatible scalar
