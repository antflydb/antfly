...
8. **CTEs and materialized stream bounds.**
   ...
   cross-table set operations, including `UNION ALL` and exact projected-row
   `EXCEPT` subtraction across two catalog tables. Cross-table branches are
