...
`replace`, `regexp_replace`, `regexp_like`, `regexp_count`, `regexp_instr`, `translate`, `substring`, and `overlay`, and text-boundary predicates such as `starts_with` and
...
`lower`, `upper`, `initcap`, `trim`, `ltrim`, `rtrim`, `replace`, `regexp_replace`, `regexp_count`, `regexp_instr`, `translate`,
...
`upper`, `initcap`, `trim`/`btrim`, `ltrim`, `rtrim`, `replace`, `regexp_replace`, `regexp_count`, `regexp_instr`, `substring`, `overlay`, `split_part`, `strpos`,
