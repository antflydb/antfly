...
pub const WriteProfile = struct {
    ...
    posting_base_members: u64 = 0,
    posting_base_blocks: u64 = 0,
    posting_base_member_probe_calls: u64 = 0,
    posting_base_member_probe_blocks_seen: u64 = 0,
    posting_base_member_probe_blocks_skipped_by_max: u64 = 0,
    posting_base_member_probe_blocks_decoded: u64 = 0,
    posting_base_member_probe_members_decoded: u64 = 0,
    posting_base_fixed_width_value_bytes: u64 = 0,
