...
from ..models.termite_generate_request_backend import TermiteGenerateRequestBackend
from ..models.termite_generate_request_cache_dtype import TermiteGenerateRequestCacheDtype
from ..models.termite_generate_request_compiled_target import TermiteGenerateRequestCompiledTarget
from ..models.termite_generate_request_mode import TermiteGenerateRequestMode
from ..models.termite_tool_choice_type_0 import TermiteToolChoiceType0
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.termite_chat_message import TermiteChatMessage
    from ..models.termite_generate_response_format import TermiteGenerateResponseFormat
    from ..models.termite_tool import TermiteTool
    from ..models.termite_tool_choice_type_1 import TermiteToolChoiceType1


T = TypeVar("T", bound="TermiteGenerateRequest")


@_attrs_define
class TermiteGenerateRequest:
    """
    Attributes:
        model (str): Name of the generator model from models_dir/generators/ Example: google/gemma-3-1b-it.
        messages (list[TermiteChatMessage]): Conversation messages (OpenAI-compatible format)
        ...
        top_k (int | Unset): Top-k sampling (Termite extension, not in OpenAI API) Default: 50.
        stream (bool | Unset): If true, partial message deltas will be sent as SSE events Default: False.
        tools (list[TermiteTool] | Unset): List of tools (functions) the model can call.
        ...
        response_format (TermiteGenerateResponseFormat | Unset):
        grammar (str | Unset): Termite-native grammar override. When set, this takes precedence over `response_format`.
            Grammar-constrained decoding is currently native-backend only.
        draft_model (str | Unset): Termite-native speculative decoding extension. Path or model identifier for a smaller
            draft model.
        speculative_k (int | Unset): Termite-native speculative decoding extension. Number of draft tokens proposed per
            verification round.
             Default: 4.
        cache_dtype (TermiteGenerateRequestCacheDtype | Unset): Termite-native KV cache quantization format. Lower
        ...
        cache_compaction_ratio (float | Unset): Termite-native KV cache compaction ratio applied after prefill via
            Attention Matching.
        ...
        backend (TermiteGenerateRequestBackend | Unset): Optional backend override for this request.
        ...
        mode (TermiteGenerateRequestMode | Unset): Termite-native graph execution mode. `eager` keeps the direct runtime
            path when possible.
            `compiled` runs Termite graph planning, partitioning, and backend executor attachment.
        compiled_target (TermiteGenerateRequestCompiledTarget | Unset): Termite-native compiled graph target.
            ...
            traced graph shape.
        tool_choice (TermiteToolChoiceType0 | TermiteToolChoiceType1 | Unset): Controls how the model uses tools.
            Options:
    ...
    model: str
    messages: list[TermiteChatMessage]
    max_tokens: int | Unset = 256
    temperature: float | Unset = 1.0
    top_p: float | Unset = 1.0
    top_k: int | Unset = 50
    stream: bool | Unset = False
    tools: list[TermiteTool] | Unset = UNSET
    min_p: float | Unset = 0.0
    repetition_penalty: float | Unset = 1.0
    frequency_penalty: float | Unset = 0.0
    presence_penalty: float | Unset = 0.0
    response_format: TermiteGenerateResponseFormat | Unset = UNSET
    grammar: str | Unset = UNSET
    draft_model: str | Unset = UNSET
    speculative_k: int | Unset = 4
    cache_dtype: TermiteGenerateRequestCacheDtype | Unset = UNSET
    cache_compaction_ratio: float | Unset = UNSET
    backend: TermiteGenerateRequestBackend | Unset = UNSET
    mode: TermiteGenerateRequestMode | Unset = UNSET
    compiled_target: TermiteGenerateRequestCompiledTarget | Unset = UNSET
    tool_choice: TermiteToolChoiceType0 | TermiteToolChoiceType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.tool_choice, Unset):
            tool_choice = UNSET
        elif isinstance(self.tool_choice, TermiteToolChoiceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for messages_item_data in _messages:
            messages_item = TermiteChatMessage.from_dict(messages_item_data)
        ...
        if _tools is not UNSET:
            ...
            for tools_item_data in _tools:
                tools_item = TermiteTool.from_dict(tools_item_data)
        ...
        if isinstance(_response_format, Unset):
            ...
            response_format = TermiteGenerateResponseFormat.from_dict(_response_format)
        ...
        cache_dtype: TermiteGenerateRequestCacheDtype | Unset
        if isinstance(_cache_dtype, Unset):
            cache_dtype = UNSET
        else:
            cache_dtype = TermiteGenerateRequestCacheDtype(_cache_dtype)

        cache_compaction_ratio = d.pop("cache_compaction_ratio", UNSET)

        _backend = d.pop("backend", UNSET)
        backend: TermiteGenerateRequestBackend | Unset
        if isinstance(_backend, Unset):
            backend = UNSET
        else:
            backend = TermiteGenerateRequestBackend(_backend)

        _mode = d.pop("mode", UNSET)
        mode: TermiteGenerateRequestMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = TermiteGenerateRequestMode(_mode)

        _compiled_target = d.pop("compiled_target", UNSET)
        compiled_target: TermiteGenerateRequestCompiledTarget | Unset
        if isinstance(_compiled_target, Unset):
            compiled_target = UNSET
        else:
            compiled_target = TermiteGenerateRequestCompiledTarget(_compiled_target)

        def _parse_tool_choice(data: object) -> TermiteToolChoiceType0 | TermiteToolChoiceType1 | Unset:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                componentsschemas_termite_tool_choice_type_0 = TermiteToolChoiceType0(data)

                return componentsschemas_termite_tool_choice_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_termite_tool_choice_type_1 = TermiteToolChoiceType1.from_dict(data)

            return componentsschemas_termite_tool_choice_type_1

        tool_choice = _parse_tool_choice(d.pop("tool_choice", UNSET))

        termite_generate_request = cls(
            model=model,
            messages=messages,
        ...
        termite_generate_request.additional_properties = d
        return termite_generate_request
