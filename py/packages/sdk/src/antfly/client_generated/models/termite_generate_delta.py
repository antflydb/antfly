...
if TYPE_CHECKING:
    from ..models.termite_tool_call_delta import TermiteToolCallDelta


T = TypeVar("T", bound="TermiteGenerateDelta")


@_attrs_define
class TermiteGenerateDelta:
    ...
    role: TermiteRole | Unset = UNSET
    content: None | str | Unset = UNSET
    tool_calls: list[TermiteToolCallDelta] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role: TermiteRole | Unset
        if isinstance(_role, Unset):
            role = UNSET
        else:
            role = TermiteRole(_role)
        ...
        if _tool_calls is not UNSET:
            ...
            for tool_calls_item_data in _tool_calls:
                tool_calls_item = TermiteToolCallDelta.from_dict(tool_calls_item_data)

                tool_calls.append(tool_calls_item)

        termite_generate_delta = cls(
            role=role,
            content=content,
            tool_calls=tool_calls,
        )

        termite_generate_delta.additional_properties = d
        return termite_generate_delta
