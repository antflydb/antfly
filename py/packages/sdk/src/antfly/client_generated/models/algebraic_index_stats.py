...
from ..models.algebraic_index_stats_planner_last_unsupported_reason import (
...
class AlgebraicIndexStats:
    ...
    remain internal diagnostics.
        ...
        Attributes:
            ...
            planner_last_unsupported_reason (AlgebraicIndexStatsPlannerLastUnsupportedReason | Unset): Stable planner
                unsupported bucket for the latest fallback decision.
    ...
    planner_last_unsupported_reason: AlgebraicIndexStatsPlannerLastUnsupportedReason | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        planner_last_unsupported_reason: str | Unset = UNSET
        if not isinstance(self.planner_last_unsupported_reason, Unset):
            planner_last_unsupported_reason = self.planner_last_unsupported_reason.value
        ...
        if planner_last_unsupported_reason is not UNSET:
            field_dict["planner_last_unsupported_reason"] = planner_last_unsupported_reason
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _planner_last_unsupported_reason = d.pop("planner_last_unsupported_reason", UNSET)
        planner_last_unsupported_reason: AlgebraicIndexStatsPlannerLastUnsupportedReason | Unset
        if isinstance(_planner_last_unsupported_reason, Unset):
            planner_last_unsupported_reason = UNSET
        else:
            planner_last_unsupported_reason = AlgebraicIndexStatsPlannerLastUnsupportedReason(
                _planner_last_unsupported_reason
            )
        ...
        algebraic_index_stats = cls(
            ...
            planner_last_unsupported_reason=planner_last_unsupported_reason,
