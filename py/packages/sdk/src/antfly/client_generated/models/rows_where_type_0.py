...
from ..models.rows_where_type_0_op import RowsWhereType0Op
from ..types import UNSET, Unset

T = TypeVar("T", bound="RowsWhereType0")


@_attrs_define
class RowsWhereType0:
    """
    Attributes:
        field (str): Declared relational column for a single top-level atom.
        op (RowsWhereType0Op):
