...
T = TypeVar("T", bound="ExtractionResolverOptions")


@_attrs_define
class ExtractionResolverOptions:
    """Optional cross-input entity and relation deduplication.

    Attributes:
        similarity_threshold (float | Unset):  Default: 0.85.
        type_must_match (bool | Unset):  Default: True.
        min_entity_confidence (float | Unset):  Default: 0.0.
        min_relation_confidence (float | Unset):  Default: 0.0.
        deduplicate_relations (bool | Unset):  Default: True.
        track_provenance (bool | Unset):  Default: True.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extraction_resolver_options = cls(
        ...
        extraction_resolver_options.additional_properties = d
        return extraction_resolver_options
