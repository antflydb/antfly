...
T = TypeVar("T", bound="TextAnalysisConfigCharFilters")


@_attrs_define
class TextAnalysisConfigCharFilters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        text_analysis_config_char_filters = cls()
        ...
        text_analysis_config_char_filters.additional_properties = additional_properties
        return text_analysis_config_char_filters
