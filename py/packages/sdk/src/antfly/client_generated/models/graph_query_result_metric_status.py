...
T = TypeVar("T", bound="GraphQueryResultMetricStatus")


@_attrs_define
class GraphQueryResultMetricStatus:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        graph_query_result_metric_status = cls()
        ...
        graph_query_result_metric_status.additional_properties = additional_properties
        return graph_query_result_metric_status
