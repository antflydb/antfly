...
if TYPE_CHECKING:
    from ..models.transaction_session_read_snapshot import TransactionSessionReadSnapshot
    from ..models.transaction_session_table_detail import TransactionSessionTableDetail


T = TypeVar("T", bound="TransactionSessionDetailsResponse")


@_attrs_define
class TransactionSessionDetailsResponse:
    """
    Attributes:
        transaction_id (str):
        owner_node_id (int):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        read_snapshots: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.read_snapshots, Unset):
            read_snapshots = []
            for read_snapshots_item_data in self.read_snapshots:
                read_snapshots_item = read_snapshots_item_data.to_dict()
                read_snapshots.append(read_snapshots_item)

        savepoint_ids: list[int] | Unset = UNSET
        if not isinstance(self.savepoint_ids, Unset):
        ...
        if read_snapshots is not UNSET:
            field_dict["read_snapshots"] = read_snapshots
        if savepoint_ids is not UNSET:
            field_dict["savepoint_ids"] = savepoint_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _tables is not UNSET:
            ...
            for tables_item_data in _tables:
                tables_item = TransactionSessionTableDetail.from_dict(tables_item_data)

                tables.append(tables_item)

        _read_snapshots = d.pop("read_snapshots", UNSET)
        read_snapshots: list[TransactionSessionReadSnapshot] | Unset = UNSET
        if _read_snapshots is not UNSET:
            read_snapshots = []
            for read_snapshots_item_data in _read_snapshots:
                read_snapshots_item = TransactionSessionReadSnapshot.from_dict(read_snapshots_item_data)

                read_snapshots.append(read_snapshots_item)

        savepoint_ids = cast(list[int], d.pop("savepoint_ids", UNSET))

        transaction_session_details_response = cls(
            transaction_id=transaction_id,
            owner_node_id=owner_node_id,
            begin_timestamp=begin_timestamp,
            last_touched_timestamp=last_touched_timestamp,
        ...
        transaction_session_details_response.additional_properties = d
        return transaction_session_details_response
