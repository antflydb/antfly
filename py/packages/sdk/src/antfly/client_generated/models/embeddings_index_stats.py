...
class EmbeddingsIndexStats:
    ...
    Attributes:
        ...
        query_visible_doc_count (int | Unset):
        ...
        dense_publish_pending (bool | Unset):
        ...
        hbc_cache (EmbeddingsIndexStatsHbcCache | Unset): Dense-vector cache diagnostics.
        hbc_posting (EmbeddingsIndexStatsHbcPosting | Unset): Dense-vector posting diagnostics.
        enrichment_runtime (EmbeddingsIndexStatsEnrichmentRuntime | Unset): Managed enrichment runtime diagnostics.
        async_indexing (EmbeddingsIndexStatsAsyncIndexing | Unset): Derived-index background indexing diagnostics.
    """
