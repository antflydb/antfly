...
T = TypeVar("T", bound="CreatedIndexCommon")


@_attrs_define
class CreatedIndexCommon:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_index_common.additional_properties = d
        return created_index_common
