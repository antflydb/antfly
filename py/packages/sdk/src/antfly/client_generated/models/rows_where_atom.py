...
from ..models.rows_where_atom_op import RowsWhereAtomOp
from ..types import UNSET, Unset

T = TypeVar("T", bound="RowsWhereAtom")


@_attrs_define
class RowsWhereAtom:
    """Typed scalar, array, JSON, or text-pattern row predicate atom over a
    ...
    operator-specific fields against the table schema.
        ...
        Attributes:
            field (str): Declared relational column.
            op (RowsWhereAtomOp):
