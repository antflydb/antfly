...
class RowsLateralPlanRequest:
    """Typed row-lateral plan envelope. Accepts exactly `lateral` plus optional ordered `ctes`, optional left/right table
    names, and paired `left_ranges` and `right_ranges`.
