...
from ...models.relational_row_mutation_request import RelationalRowMutationRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/db/v1/databases/{database_name}/namespaces/{namespace_name}/tables/{table_name}/constraints/repair".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        namespace_name (str):
        table_name (str):
        body (RelationalRowMutationRequest): Atomic version-conditional typed-row replacements and
            deletions using the durable distributed transaction coordinator.
