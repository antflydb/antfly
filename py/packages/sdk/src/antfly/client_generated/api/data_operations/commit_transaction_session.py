...
from ...models.transaction_session_commit_response import TransactionSessionCommitResponse
...
def _get_kwargs(
    transaction_id: str,
    *,
    body: TransactionCommitRequest | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | TransactionSessionCommitResponse | None:
    if response.status_code == 200:
        response_200 = TransactionSessionCommitResponse.from_dict(response.json())

        return response_200

    if response.status_code == 202:
        response_202 = TransactionSessionCommitResponse.from_dict(response.json())
    ...
    if response.status_code == 409:
        response_409 = TransactionSessionCommitResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | TransactionSessionCommitResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        transaction_id (str):
        body (TransactionCommitRequest | Unset): Stateless OCC (Optimistic Concurrency Control)
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | TransactionSessionCommitResponse
    """
