...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/db/v1/tables/{table_name}/relational-column-backed-index-repair".format(
...
) -> Error | RelationalColumnBackedIndexRepairResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | RelationalColumnBackedIndexRepairResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    entries for the default public table.
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | RelationalColumnBackedIndexRepairResponse
    """
