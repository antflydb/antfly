...
class GraphIndexStatsAlgebraicGraph:
    ...
    Attributes:
        traversal (Union[Unset, GraphIndexStatsAlgebraicGraphTraversal]):
    """

    traversal: Union[Unset, "GraphIndexStatsAlgebraicGraphTraversal"] = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        traversal: Union[Unset, dict[str, Any]] = UNSET
