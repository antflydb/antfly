...
.PHONY: zig-build zig-test zig-unit-test zig-sql-api-parity-test zig-db-temporal-test zig-graph-metric-lifecycle-test zig-graph-metric-cleanup-test zig-graph-metric-degree-canary-test zig-graph-metric-default-gate-test zig-graph-metric-fan-in-test zig-graph-metric-operations-test zig-public-api-graph-metric-e2e-test zig-graph-metric-process-test zig-graph-metric-distributed-release-gate zig-graph-metric-distributed-promotion-gate zig-graph-metric-release-qualification zig-generate zig-openapi-generate zig-generated-check zig-openapi-check zig-snowball-check zig-license-headers zig-license-check zig-tla-check
